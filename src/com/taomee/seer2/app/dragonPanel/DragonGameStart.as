package com.taomee.seer2.app.dragonPanel
{
   ...
   public class DragonGameStart extends Sprite
   {
      ...
      private var _downList:Vector.<DragonDownItem>;
      ...
      private function initMC() : void
      {
         ...
         this._downList = Vector.<DragonDownItem>([]);
         this._time = 2500;
      ...
      private function itemDown() : void
      {
         ...
         var _loc1_:DragonDownItem = new DragonDownItem(this._currType,this._libs);
         this._mainUI.addChild(_loc1_);
         this._downList.push(_loc1_);
         this.dragonPoint(_loc1_);
      }
      
      private function dragonPoint(param1:DragonDownItem) : void
      {
      ...
      {
         var dragon:DragonDownItem = null;
      ...
      {
         var _loc1_:DragonDownItem = null;
         Connection.removeCommandListener(CommandSet.TREAT_ALL_PET_1215,this.onAddAllPetBlood);
         this._isStop = true;
