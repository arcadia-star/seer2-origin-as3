package com.taomee.seer2.app.dream
{
   ...
   public class DreamMapOrganize extends Sprite
   {
      ...
      private static var _instance:DreamMapOrganize;
      
      private static var _mapInfo:DreamMapInfo;
      ...
      private static function get instance() : DreamMapOrganize
      {
         if(_instance == null)
         {
            _instance = new DreamMapOrganize();
         }
         return _instance;
      }
      ...
      public static function setInfo(param1:DreamMapInfo) : void
      {
         _mapInfo = param1;
      }
      ...
      private function onDreamEntryMap(param1:MessageEvent) : void
      {
         ...
         _mapInfo = new DreamMapInfo(_loc2_);
         this.entryMap();
         this.dreamCheckOne();
         this.showBox();
      }
