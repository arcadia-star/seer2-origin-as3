...
public class FightWayThreeToolbar extends RightToolbar {


    public function FightWayThreeToolbar() {
        super();
    }
    ...
    override protected function onClick(param1:MouseEvent):void {
        ...
        if (!NewPlayerGuideTimeManager.timeCheckNewGuide()) {
            ...
            ServerBufferManager.getServerBuffer(ServerBufferType.NEW_PLAYER_FIGHT_OPEN, function (param1:ServerBuffer):void {
                ...
                if (param1.readDataAtPostion(3)) {
                    ActsHelperUtil.goHandle(1071);
                } else if (_loc2_ >= 18000) {
                    ActsHelperUtil.goHandle(1071);
                    ServerBufferManager.updateServerBuffer(ServerBufferType.NEW_PLAYER_FIGHT_OPEN, 3, 1);
                } else {
