...
public class FightWayFourToolbar extends RightToolbar {


    public function FightWayFourToolbar() {
        super();
    }
    ...
    override protected function onClick(param1:MouseEvent):void {
        ...
        if (!NewPlayerGuideTimeManager.timeCheckNewGuide()) {
            ActsHelperUtil.goHandle("BagginsLogPanel");
        } else {
            ServerBufferManager.getServerBuffer(ServerBufferType.NEW_PLAYER_FIGHT_OPEN, function (param1:ServerBuffer):void {
                ...
                if (param1.readDataAtPostion(4)) {
                    ActsHelperUtil.goHandle("BagginsLogPanel");
                } else if (_loc2_ >= 25000) {
                    ActsHelperUtil.goHandle("BagginsLogPanel");
                    ServerBufferManager.updateServerBuffer(ServerBufferType.NEW_PLAYER_FIGHT_OPEN, 4, 1);
                } else {
