package com.taomee.seer2.app.pet.data
{
   ...
   public class PetInfoManager
   {
      ...
      public static function getPowerByPetInfo(param1:PetInfo) : int
      {
         ...
         var _loc11_:Number = createCurPropVal(param1.getPetDefinition().maxHp + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Hp : 0),param1.learningInfo.pointHp,Hp,param1) * 1.7 + createCurPropVal(param1.getPetDefinition().atk + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Atk : 0),param1.learningInfo.pointAtk,ATK,param1) * 1.6 + createCurPropVal(param1.getPetDefinition().specialAtk + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).SpAtk : 0),param1.learningInfo.pointSpecialAtk,Spatk,param1) * 1.6 + createCurPropVal(param1.getPetDefinition().defence + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Def : 0),param1.learningInfo.pointDefence,Def,param1) * 1.4 + createCurPropVal(param1.getPetDefinition().specialDefence + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).SpDef : 0),param1.learningInfo.pointSpecialDefence,Spdef,param1) * 1.4 + createCurPropVal(param1.getPetDefinition().speed + int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Spd : 0),param1.learningInfo.pointSpeed,Spd,param1) * 3;
