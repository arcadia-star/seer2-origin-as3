...
public class QuestStepTargetCatchWild extends BaseQuestStepTarget {
    ...
    private function onSwitchComplete(param1:SceneEvent):void {
        ...
        if (SceneManager.prevSceneType == SceneType.ARENA && FightManager.fightWinnerSide == FightSide.LEFT) {
            if (FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.type && FightManager.currentFightRecord.initData.type == FightRecordData.FIGHT_WILD && FightManager.endReason == FightEndReason.CATCH_END) {
