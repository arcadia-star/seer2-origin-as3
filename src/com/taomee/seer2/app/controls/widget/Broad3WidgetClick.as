...
public class Broad3WidgetClick extends Sprite implements IWidgetable {

    public static const BROAD_CAST_FOUR:String = "Broad_3";
    ...
    public function Broad3WidgetClick(param1:MovieClip) {
        super();
        this._mainUI = param1;
    ...
    private function onWidgetClick(param1:MouseEvent):void {
        ModuleManager.showAppModule("BroadCastSixPanel");
    }
}
}
