package com.taomee.seer2.app.activity.processor.flameBattle
{
   ...
   public class ActivityMapHandler_261 extends FlameBattleMapHandler
   {
      ...
      private function processNpc() : void
      {
         ...
         if(_loc2_ <= 50)
         {
            _loc3_ = <npc id="304" resId="304" name="巴尔卡卫兵" dir="1" width="25" height="80" pos="202,360" actorPos="210,365" path="">
         ...
         {
            _loc4_ = <npc id="303" resId="303" name="洛克侍卫" dir="1" width="25" height="80" pos="202,360" actorPos="210,365" path="">
