package com.taomee.seer2.app.processor.quest.handler.main.quest78
{
   ...
   public class QuestMapHandler_78_80333 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_78_80333(param1:QuestProcessor)
      {
         super(param1);
      ...
      private function initStep2(param1:MouseEvent) : void
      {
         ...
         {
            NpcDialog.show(757,"里格",[[0,"你们没事吧？小赛尔，真的很感谢你救了我的属下。"]],["  我们没事啦"],[function():void
            {
               NpcDialog.show(821,"提尔",[[1,"抱、抱歉，刚才误会你们了。要不是你们的帮助，恐怕我已经被抓住了。小赛尔，真的非常非常感谢你！"]],[" 没关系，这是我应该做的"],[function():void
               {
                  NpcDialog.show(757,"里格",[[0,"对了，正式自我介绍一下，我是里格，是反萨联盟的队长，这是提尔，是我们队的先锋。"]],[" 反萨联盟？"],[function():void
                  {
                     NpcDialog.show(757,"里格",[[2,"我们不甘受到萨伦帝国的奴役，不愿成为萨伦统治全球的工具，所以暗地里成立了“反萨联盟”，默默的积蓄力量，为了自由而奋战！"]],["..."],[function():void
                     {
                        NpcDialog.show(757,"里格",[[0,"如你们所见，这里是超能氏族的一处密道，与虫群氏族相连。我们将这里作为“反萨联盟”的秘密基地。"]],["  原来是这样。"],[function():void
                        {
                           NpcDialog.show(757,"里格",[[0,"但是现在，这里已经被萨伦的精灵发现，不再安全，我们必须马上转移。小赛尔，跟我来吧。"]],[" 好的。"],[function():void
                           {
                              initStep3();
                           }]);
                        }]);
      ...
      {
         this._mc2 = _processor.resLib.getMovieClip("Mc77_0");
      ...
      {
         this._npc.removeEventListener(MouseEvent.CLICK,this.initStep2);
