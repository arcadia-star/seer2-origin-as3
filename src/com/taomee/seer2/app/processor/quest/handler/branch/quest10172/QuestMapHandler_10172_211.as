package com.taomee.seer2.app.processor.quest.handler.branch.quest10172 {
...
public class QuestMapHandler_10172_211 extends QuestMapHandler {


    public function QuestMapHandler_10172_211(param1:QuestProcessor) {
        super(param1);
    }

    override public function processMapComplete():void {
        super.processMapComplete();
        if (QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA && FightManager.currentFightRecord.initData.positionIndex == 100003) {
    ...
    private function doWin():void {
        DayLimitManager.getDoCount(590, function (param1:int):void {
            if (param1 + 1 == 1) {
                ...
                ServerMessager.addMessage("你已经击败" + (param1 + 1) + "/5只发光的安可！");
            }
        });
