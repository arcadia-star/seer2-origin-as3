...
public class CandlePelayHandler extends QuestMapHandler {
    ...
    public static function saveQuestIndex(param1:int, param2:int):void {
        ServerBufferManager.updateServerBuffer(ServerBufferType.TORCH_RELAY5, param1, param2);
    }
    ...
    protected function setup():void {
        if (TorchRelayTime.isAppearTime()) {
            ServerBufferManager.getServerBuffer(ServerBufferType.TORCH_RELAY5, this.onGetQuestIndex);
        }
    }
