...
public class QuestMapHandler_10250_1230 extends QuestMapHandler {


    private var _mouseHint:MouseClickHintSprite;

    public function QuestMapHandler_10250_1230(param1:QuestProcessor) {
        super(param1);
    }
    ...
    private function onStep(param1:QuestEvent):void {
        if (param1 == null || param1.questId == 10250 && param1.stepId == 2) {
            QuestManager.removeEventListener(QuestEvent.STEP_COMPLETE, this.onStep);
            this._mouseHint = new MouseClickHintSprite();
            this._mouseHint.x = 34;
            this._mouseHint.y = 468;
