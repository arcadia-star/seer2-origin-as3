...
public class QuestMapHandler_30046_240 extends QuestMapHandler {
    ...
    public function QuestMapHandler_30046_240(param1:QuestProcessor) {
        super(param1);
    }
    ...
    private function onItem(param1:MouseEvent):void {
        ...
        if (this._count < 2) {
            this._count += 1;
            ServerBufferManager.updateServerBuffer(ServerBufferType.MAKE_SUIT_MATERIAL, 3, this._count);
