package com.taomee.seer2.app.processor.quest.handler.branch.quest10130
{
   ...
   public class QuestMapHandler_10130_340 extends QuestMapHandler
   {
      ...
      private var _maliangGame:MaliangGame;
      ...
      {
         this._maliangGame = new MaliangGame(_processor.resLib.getMovieClip("maliangGame"),this.gameComplete);
      }
      ...
      {
         this._game2 = new Game10130(_processor.resLib.getMovieClip("game2"),this._currStep,this.game2Complete);
      }
