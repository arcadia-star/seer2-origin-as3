...
public class QuestMapHandler_62_50 extends QuestMapHandler {
    ...
    public function QuestMapHandler_62_50(param1:QuestProcessor) {
        super(param1);
    }
    ...
    override public function processMapComplete():void {
        ...
        ServerBufferManager.getServerBuffer(ServerBufferType.LEIYI_CENTURY_FIGHT, function (param1:ServerBuffer):void {
            _flag1 = param1.readDataAtPostion(7);
            _flag2 = param1.readDataAtPostion(8);
    ...
    private function addTalk():void {
        ...
        MovieClipUtil.playMc(this._mc_0, 1, this._mc_0.totalFrames, function ():void {
            ServerBufferManager.updateServerBuffer(ServerBufferType.LEIYI_CENTURY_FIGHT, 8, 1);
