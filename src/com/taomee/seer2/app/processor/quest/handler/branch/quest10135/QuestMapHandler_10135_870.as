   ...
   public class QuestMapHandler_10135_870 extends QuestMapHandler
   {
      ...
      private function addTalk() : void
      {
         ...
         MovieClipUtil.playMc(this._mc_1,1,this._mc_1.totalFrames,function():void
         {
            ...
            {
               _game = new Game10135(_processor.resLib.getMovieClip("game"),0,gameComplete);
            }]);
         },true);
      }
      ...
      {
         this._game = new Game10135(_processor.resLib.getMovieClip("game"),0,this.gameComplete);
      }
      ...
      private function maliangTalk() : void
      {
         ...
         {
            _game = new Game10135(_processor.resLib.getMovieClip("game"),1,game2Complete);
         }]);
      }
