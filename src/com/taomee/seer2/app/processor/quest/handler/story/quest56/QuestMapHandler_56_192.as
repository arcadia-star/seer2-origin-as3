package com.taomee.seer2.app.processor.quest.handler.story.quest56
{
   ...
   public class QuestMapHandler_56_192 extends QuestMapHandler
   {
       
      
      public function QuestMapHandler_56_192(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      {
         if((param1.content as DialogPanelEventData).params == "56_3")
         {
            DialogPanel.addEventListener(DialogPanelEvent.CUSTOM_REPLY_CLICK,this.onStep);
      ...
      private function onStepCompleteHandler(param1:QuestEvent) : void
      {
         ...
         Connection.send(CommandSet.ITEM_EXCHANGE_1055,446,1,0);
