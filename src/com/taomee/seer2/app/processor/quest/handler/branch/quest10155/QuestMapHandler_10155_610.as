package com.taomee.seer2.app.processor.quest.handler.branch.quest10155 {
...
public class QuestMapHandler_10155_610 extends QuestMapHandler {


    public function QuestMapHandler_10155_610(param1:QuestProcessor) {
        super(param1);
    }

    override public function processMapComplete():void {
        super.processMapComplete();
        if (QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA) {
