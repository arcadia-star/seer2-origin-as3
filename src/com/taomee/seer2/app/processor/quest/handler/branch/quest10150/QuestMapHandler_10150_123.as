...
public class QuestMapHandler_10150_123 extends QuestMapHandler {
    ...
    override public function processMapComplete():void {
        ...
        if (QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA && (FightManager.currentFightRecord.initData.positionIndex == 1 || FightManager.currentFightRecord.initData.positionIndex == 4 || FightManager.currentFightRecord.initData.positionIndex == 7)) {
