package com.taomee.seer2.app.processor.quest.handler.activity.quest30044
{
   ...
   public class QuestMapHandler_30044_20 extends QuestMapHandler
   {
       
      
      private var _npc:Mobile;
      
      public function QuestMapHandler_30044_20(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      private function onQuest(param1:ServerBuffer) : void
      {
         ...
         if(count < 1)
         {
            ...
            NpcDialog.show(2,"伊娃",[[0,"新年好呀小赛尔！新的一年又什么好打算呢？把这些记在心里，慢慢地实现吧！祝你成功哦！"]],["哈哈！谢谢博士！"],[function():void
            {
               var data:* = new Object();
               data.index = 3;
