package com.taomee.seer2.app.processor.quest.handler.branch.quest10152
{
   ...
   public class QuestMapHandler_10152_490 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA && (FightManager.currentFightRecord.initData.positionIndex == 1 || FightManager.currentFightRecord.initData.positionIndex == 4 || FightManager.currentFightRecord.initData.positionIndex == 7 || FightManager.currentFightRecord.initData.positionIndex == 100011))
         {
