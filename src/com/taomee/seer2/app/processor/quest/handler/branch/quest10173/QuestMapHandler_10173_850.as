package com.taomee.seer2.app.processor.quest.handler.branch.quest10173 {
...
public class QuestMapHandler_10173_850 extends QuestMapHandler {


    public function QuestMapHandler_10173_850(param1:QuestProcessor) {
        super(param1);
    }

    override public function processMapComplete():void {
        super.processMapComplete();
        if (QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA && FightManager.currentFightRecord.initData.positionIndex == 118) {
