...
public class QuestMapHandler_30042_220 extends QuestMapHandler {
    ...
    public function QuestMapHandler_30042_220(param1:QuestProcessor) {
        super(param1);
    }
    ...
    private function onItem(param1:MouseEvent):void {
        ...
        if (this._count < 2) {
            ++this._count;
            ServerBufferManager.updateServerBuffer(ServerBufferType.OPEN_SCROOL, 2, this._count);
