package com.taomee.seer2.app.processor.quest.handler.story.quest26
{
   ...
   public class QuestMapHandler_26_520 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_26_520(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id) && QuestManager.isComplete(25))
         {
