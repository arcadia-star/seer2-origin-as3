package com.taomee.seer2.app.processor.quest.handler.story.quest27
{
   ...
   public class QuestMapHandler_27_390 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_27_390(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id) && QuestManager.isComplete(26))
         {
            this._mousePoint = new Point(412,405);
         ...
         {
            QuestManager.addEventListener(QuestEvent.COMPLETE,this.onRelateQuestComplete);
         }
      }
      
      private function onRelateQuestComplete(param1:QuestEvent) : void
      {
         if(param1.questId == 26)
         {
            QuestManager.removeEventListener(QuestEvent.COMPLETE,this.onRelateQuestComplete);
            this._mousePoint = new Point(412,405);
            ModuleManager.addEventListener("MapSignPanel",ModuleEvent.SHOW,this.onMapPanelShow);
            ModuleManager.addEventListener("MapSignPanel",ModuleEvent.HIDE,this.onMapPanelHide);
            this.addMouseHint(72,490);
