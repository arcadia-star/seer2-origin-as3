...
public class QuestMapHandler_30054_122 extends QuestMapHandler {
    ...
    public function QuestMapHandler_30054_122(param1:QuestProcessor) {
        super(param1);
    }
    ...
    private function onCLick(param1:MouseEvent):void {
        ...
        if (this._count < 2) {
            this._count += 1;
            ServerBufferManager.updateServerBuffer(ServerBufferType.MAKE_TABARD_MATERIAL, 1, this._count);
            ServerMessager.addMessage("恭喜你获得了一个护甲碎片");
