...
public class MapProcessor_80309 extends MapProcessor {

    private static const FIGHT_NUM_DAY:int = 1327;

    private static const FIGHT_INDEX_LIST:Vector.<int> = Vector.<int>([1206, 1206, 1206, 1206, 1206]);

    private static const FIGHT_NUM_MI_BUY_FOR:int = 204703;
    ...
    public function MapProcessor_80309(param1:MapModel) {
        super(param1);
    }
    ...
    private function fightOver(param1:SceneEvent):void {
        if (SceneManager.prevSceneType == SceneType.ARENA) {
            ...
            SceneManager.changeScene(SceneType.LOBBY, 70);
            ModuleManager.showModule(URLUtil.getAppModule("FYaSiSuperProcessPanel"), "正在打开面板...");
        }
    }

    private function onWaterClick(param1:MouseEvent):void {
        SceneManager.addEventListener(SceneEvent.SWITCH_COMPLETE, this.fightOver);
        FightManager.startFightWithWild(1206);
    }
