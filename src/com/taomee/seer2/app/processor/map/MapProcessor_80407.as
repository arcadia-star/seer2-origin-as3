...
public class MapProcessor_80407 extends MapProcessor {

    private static const FOR_LIST:Array = [205660, 205656, 205662, 205657];

    private static const DAY_LIST:Array = [1642];

    private static const FIGHT_INDEX:int = 1517;

    private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605525, 500624, 605524]);
    ...
    public function MapProcessor_80407(param1:MapModel) {
        super(param1);
    }
    ...
    private function onHurtBuy(param1:MouseEvent):void {
        ...
        ActiveCountManager.requestActiveCountList(FOR_LIST, function (param1:Parser_1142):void {
            ...
            if (Boolean(_par.infoVec[3])) {
                AlertManager.showAlert("你已经有东蛮荣耀了,快去战斗吧!");
            } else {
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(870);
