...
{
   import com.taomee.seer2.app.processor.map.diceThing.DiceMapPterosaurManager;
   ...
   public class MapProcessor_10374 extends MapProcessor
   {
      ...
      public function MapProcessor_10374(param1:MapModel)
      {
         super(param1);
      }
      ...
      override public function init() : void
      {
         ...
         DiceMapPterosaurManager.getInstance().setup();
      }
      
      private function openHelp(param1:MouseEvent) : void
      {
         ModuleManager.toggleModule(URLUtil.getAppModule("PterosaurHelpPanel"));
      }
