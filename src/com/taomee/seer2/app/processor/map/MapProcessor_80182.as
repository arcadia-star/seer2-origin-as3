...
public class MapProcessor_80182 extends MapProcessor {

    private static const FIGHT_INDEX:int = 943;

    private static const FIGHT_NUM_DAY:int = 204080;

    private static const FIGHT_NUM_MI_BUY_FOR:int = 204084;
    ...
    public function MapProcessor_80182(param1:MapModel) {
        super(param1);
    }
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(752);
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(752, "潘多拉", [[0, "魔匣的诅咒无法控制我的斗志，来吧！"]], ["开始挑战", "准备一下"], [function ():void {
