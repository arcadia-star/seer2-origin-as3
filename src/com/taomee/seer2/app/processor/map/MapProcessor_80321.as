package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80321 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [204836,204837];
      
      private static const DAY_LIST:Array = [1364,1363];
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([500613]);
      
      private static const FIGHT_INDEX:int = 1271;
      ...
      public function MapProcessor_80321(param1:MapModel)
      {
         super(param1);
      }
      ...
      {
         ModuleManager.showModule(URLUtil.getAppModule("SkyHorseTipPanel"),"正在打开面板...",{"hurtNum":int(this._hurtNum.text)});
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(819);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "苍耀神尊";
      ...
      {
         var evt:MouseEvent = param1;
         NpcDialog.show(819,"苍耀神尊",[[0,"我就是苍耀神尊！ 神尊的荣耀不可任你践踏！来受死吧！"]],["打吧","我好怕你"],[function():void
         {
