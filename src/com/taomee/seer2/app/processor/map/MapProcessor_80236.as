package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80236 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [204514,204512];
      
      private static const DAY_LIST:Array = [1265];
      
      private static const FIGHT_INDEX:Vector.<uint> = Vector.<uint>([1129,1130,1131,1132]);
      
      private static const LAST_TIME:int = 300;
      
      private static const RES_ID:int = 758;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([604031]);
      ...
      public function MapProcessor_80236(param1:MapModel)
      {
         super(param1);
      }
