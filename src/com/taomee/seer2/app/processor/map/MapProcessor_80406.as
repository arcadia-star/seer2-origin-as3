package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80406 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1639];
      
      private static const FOR_LIST:Array = [205655,205662];
      
      private static const FIGHT_INDEX:int = 1516;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605523]);
      ...
      public function MapProcessor_80406(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(869);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "火翼炎神";
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(869,"火翼炎神",[[0,"  烈火克蛮草，有胆量！东界王既然来此，炎神有幸和你过招了！"]],["请赐教！","我还没有准备好"],[function():void
         {
