...
import com.taomee.seer2.app.processor.map.diceThing.DiceMapLuffyManager;
...
public class MapProcessor_10371 extends MapProcessor {
    ...
    public function MapProcessor_10371(param1:MapModel) {
        super(param1);
    }
    ...
    override public function init():void {
        ...
        DiceMapLuffyManager.getInstance().setup();
    }

    private function openHelp(param1:MouseEvent):void {
        ModuleManager.toggleModule(URLUtil.getAppModule("LuffyHelpPanel"));
    }
