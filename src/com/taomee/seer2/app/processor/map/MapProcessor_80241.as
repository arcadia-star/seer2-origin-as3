package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80241 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1276];
      
      private static const FIGHT_INDEX:int = 1158;
      ...
      public function MapProcessor_80241(param1:MapModel)
      {
         super(param1);
      }
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               if(canFightNum > 0)
               {
                  ...
                  else
                  {
                     ...
                     {
                        ModuleManager.showAppModule("LeiYiGetFireMainPanel");
                     });
                  }
               }
               else
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(692);
