package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80228 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1236];
      
      private static const FIGHT_INDEX:int = 1105;
      
      private static const FIGHT_NUM_RULE:int = 3;
      
      private static const TIP_POS:Point = new Point(460,180);
       
      
      private var _npc:Mobile;
      
      public function MapProcessor_80228(param1:MapModel)
      {
         super(param1);
      }
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               if(canFightNum > 0)
               {
                  ...
                  else
                  {
                     ...
                     {
                        ModuleManager.showAppModule("GaiYaGetFireMainPanel");
                     });
                  }
               }
               else
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(762);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "逆世盖亚";
