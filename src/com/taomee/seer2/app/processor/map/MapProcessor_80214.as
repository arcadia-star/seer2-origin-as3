...
public class MapProcessor_80214 extends MapProcessor {

    private static const DAY_LIST:Array = [1194];

    private static const FIGHT_INDEX:int = 1038;
    ...
    public function MapProcessor_80214(param1:MapModel) {
        super(param1);
    }
