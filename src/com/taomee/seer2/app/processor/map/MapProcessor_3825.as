...
public class MapProcessor_3825 extends MapProcessor {


    private var MAXNUM:int = 15;

    private var oldNum:int;

    private var _npc:SpawnedPet;

    private var fightID:int = 1451;

    public function MapProcessor_3825(param1:MapModel) {
        super(param1);
    }
