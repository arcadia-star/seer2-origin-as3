package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80185 extends MapProcessor
   {
      
      private static const FIGHT_INDEX:int = 946;
      
      private static const FIGHT_NUM_DAY:int = 204083;
      
      private static const FIGHT_NUM_MI_BUY_FOR:int = 204087;
      ...
      public function MapProcessor_80185(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.setPostion(new Point(380,320));
            this._npc.resourceUrl = URLUtil.getNpcSwf(753);
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(753,"宙斯",[[0,"力量！权威！大帝！我是这奥林匹斯山的统领！"]],["开始挑战","准备一下"],[function():void
         {
