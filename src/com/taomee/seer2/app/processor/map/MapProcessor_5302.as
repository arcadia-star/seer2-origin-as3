...
public class MapProcessor_5302 extends MapProcessor {


    public function MapProcessor_5302(param1:MapModel) {
        super(param1);
    }
    ...
    private function getFightNum():void {
        ...
        var _loc1_:int = 0;
        while (_loc1_ < 5) {
            _loc2_ = new SpawnedPet(80, 268, 0);
