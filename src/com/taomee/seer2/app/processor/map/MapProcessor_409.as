...
public class MapProcessor_409 extends MapProcessor {
    ...
    public function MapProcessor_409(param1:MapModel) {
        super(param1);
    }
    ...
    override public function init():void {
        ...
        this._doorSupport = Atletico50V50DoorSupport.getInstance();
