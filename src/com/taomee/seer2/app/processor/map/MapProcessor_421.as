...
public class MapProcessor_421 extends MapProcessor {
    ...
    private var _doorSupport:BinaryDoorSupport;

    public function MapProcessor_421(param1:MapModel) {
        super(param1);
    }
    ...
    override public function init():void {
        ...
        this._doorSupport = BinaryDoorSupport.getInstance();
