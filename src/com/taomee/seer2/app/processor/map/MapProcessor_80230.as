...
public class MapProcessor_80230 extends MapProcessor {

    private static const DAY_LIST:Array = [1239];

    private static const FOR_LIST:Array = [204424, 204428];

    private static const FIGHT_INDEX:int = 1106;

    private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([604004]);
    ...
    public function MapProcessor_80230(param1:MapModel) {
        super(param1);
    }
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(694, "黑武士", [[0, "     想帮盖亚那小子进化？估计它这辈子都没希望了"]], ["来战一局灭灭你的威风！", "挺吓人的呢"], [function ():void {
