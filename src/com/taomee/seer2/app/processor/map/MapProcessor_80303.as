package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80303 extends MapProcessor
   {
      ...
      public function MapProcessor_80303(param1:MapModel)
      {
         super(param1);
      }
      ...
      override public function init() : void
      {
         ...
         this.npc = MobileManager.getMobile(815,MobileType.NPC);
