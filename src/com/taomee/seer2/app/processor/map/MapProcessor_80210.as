package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80210 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [204275,204276];
      
      private static const DAY_LIST:Array = [1170];
      
      private static const FIGHT_INDEX:Vector.<uint> = Vector.<uint>([1016,1018,1019,1020]);
      
      private static const LAST_TIME:int = 600;
      
      private static const RES_ID:int = 1101;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([603886]);
      ...
      public function MapProcessor_80210(param1:MapModel)
      {
         super(param1);
      }
