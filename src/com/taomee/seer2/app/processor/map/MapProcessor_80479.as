package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80479 extends MapProcessor
   {
      
      private static const FIGHT_COUNT:uint = 958;
      
      private static const BUY_COUNT:uint = 203669;
      
      private static const FIGHT_INDEX:int = 793;
      
      private static const NPC_ID:int = 3026;
      ...
      public function MapProcessor_80479(param1:MapModel)
      {
         super(param1);
      }
      ...
      override public function init() : void
      {
         ...
         if(currentDate.hours == 20 && currentDate.minutes >= 28)
         {
            currentDate.minutes = 30;
         }
         if(currentDate.hours < 20 || currentDate.hours > 22 || currentDate.hours == 20 && currentDate.minutes < 30)
         {
            AlertManager.showAlert("不在活动范围内，活动时间为20：30-22：00",function():void
            {
               SceneManager.changeScene(SceneType.LOBBY,70);
            });
            return;
         }
         DayLimitManager.getDoCount(FIGHT_COUNT,this.getDayData);
      ...
      private function getDayData(param1:uint) : void
      {
         ...
         ActiveCountManager.requestActiveCount(BUY_COUNT,this.getBuyCount);
      }
      ...
      {
         if((param1.content as DialogPanelEventData).params == "haoYueKingToFight")
         {
         ...
         else if((param1.content as DialogPanelEventData).params == "haoYueKingSeeRank")
         {
            ModuleManager.showAppModule("HaoYueKingBossActPanel");
         }
      }
