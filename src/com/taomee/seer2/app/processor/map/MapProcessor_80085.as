package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80085 extends MapProcessor
   {
      
      private static const FIGHT_INDEX:int = 722;
      
      private static const FIGHT_NUM_DAY:int = 880;
      
      private static const FIGHT_NUM_MI_BUY_FOR:int = 203448;
      ...
      public function MapProcessor_80085(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.width = 75;
            this._npc.height = 210;
            this._npc.setPostion(new Point(502,363));
            this._npc.resourceUrl = URLUtil.getNpcSwf(536);
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(536,"萨弗拉",[[0,"圣火种必在我地狱火守护中！想抢？先赢我！"]],["挑战吧！","准备一下"],[function():void
         {
