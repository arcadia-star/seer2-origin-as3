...
public class MapProcessor_80404 extends MapProcessor {

    private static const FOR_LIST:Array = [205661];

    private static const DAY_LIST:Array = [1635];

    private static const FIGHT_INDEX_LIST:Vector.<int> = Vector.<int>([1511, 1512, 1513]);

    private static const RES_LIST:Vector.<int> = Vector.<int>([76, 130, 193]);
    ...
    public function MapProcessor_80404(param1:MapModel) {
        super(param1);
    }
        ...
        if (SceneManager.prevSceneType == SceneType.ARENA && FIGHT_INDEX_LIST.indexOf(FightManager.currentFightRecord.initData.positionIndex) != -1) {
            ActiveCountManager.requestActiveCountList(FOR_LIST, function (param1:Parser_1142):void {
                ...
                DayLimitListManager.getDaylimitList(DAY_LIST, function (param1:DayLimitListInfo):void {
                    ...
                    if (par.infoVec[0] >= 20) {
                        ServerMessager.addMessage("已获得足够的蛮之力了哦!");
