...
public class MapProcessor_80472 extends MapProcessor {

    private static const FOR_LIST:Array = [205856, 205855];

    private static const DAY_LIST:Array = [1725];

    private static const FIGHT_INDEX:Vector.<uint> = Vector.<uint>([1610, 1611, 1612, 1613]);

    private static const LAST_TIME:int = 300;

    private static const RES_ID:int = 904;

    private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605885]);
    ...
    public function MapProcessor_80472(param1:MapModel) {
        super(param1);
    }
