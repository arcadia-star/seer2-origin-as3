...
public class MapProcessor_80216 extends MapProcessor {

    private static const DAY_LIST:Array = [1192];

    private static const FOR_LIST:Array = [204320, 204334];

    private static const FIGHT_INDEX:int = 1044;

    private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([603925]);
    ...
    public function MapProcessor_80216(param1:MapModel) {
        super(param1);
    }
    ...
    private function initSet():void {
        ...
        if (BitUtil.getBit(this._par.infoVec[1], 1)) {
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(375);
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(719, "地煞", [[0, "想帮卡修斯那小子进化？估计它这辈子都没希望了"]], ["怎么会是你！我找的是宙斯大神！", "挺吓人的呢"], [function ():void {
            NpcDialog.show(753, "宙斯", [[0, "我的神光将印证你的勇气！但小赛尔你需要先扫除地煞障碍才能和我交手！"]], ["好！那我就先和这个煞战一局 "], [function ():void {
