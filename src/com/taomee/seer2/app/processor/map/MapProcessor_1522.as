...
public class MapProcessor_1522 extends MapProcessor {


    public function MapProcessor_1522(param1:MapModel) {
        super(param1);
    }
    ...
    private function getFightNum():void {
        ...
        var _loc1_:int = 0;
        while (_loc1_ < 5) {
            _loc2_ = new SpawnedPet(57, 267, 0);
