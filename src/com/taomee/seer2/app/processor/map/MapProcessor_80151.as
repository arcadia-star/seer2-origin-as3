...
public class MapProcessor_80151 extends MapProcessor {

    private static const FIGHT_NUM_DAY:int = 1015;

    private static const FIGHT_INDEX_LIST:Vector.<int> = Vector.<int>([837, 838, 839, 840, 841]);

    private static const FIGHT_NUM_MI_BUY_FOR:int = 203819;
    ...
    public function MapProcessor_80151(param1:MapModel) {
        super(param1);
    }
