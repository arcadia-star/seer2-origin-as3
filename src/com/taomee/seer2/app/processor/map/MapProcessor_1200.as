...
public class MapProcessor_1200 extends MapProcessor {
    ...
    private var fightID:int = 1453;

    public function MapProcessor_1200(param1:MapModel) {
        super(param1);
    }

    override public function init():void {
        var result:uint = 0;
        StatisticsManager.sendNovice(StatisticsManager.ui_interact_466);
        this.randomWild();
