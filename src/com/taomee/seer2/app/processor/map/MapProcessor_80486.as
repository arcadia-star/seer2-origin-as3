...
public class MapProcessor_80486 extends MapProcessor {
    ...
    override public function init():void {
        this._npc = MobileManager.getMobile(this.F_PET_ID, MobileType.NPC);
    ...
    private function onClickNPC(param1:MouseEvent):void {
        ...
        NpcDialog.show(this.S_PET_ID, this.S_PET_NAME, [[0, "水脉的守护之神，我需要得到你的认可，完成我彻底的觉醒!"]], ["请给赐予我力量"], [function ():void {
            NpcDialog.show(F_PET_ID, F_PET_NAME, [[0, "我以最纯真血脉之名赐予你每天5次试炼的机会，能否得到我的认可，就看你自身的能力了！"]], ["我不会让你失望的"], [function ():void {
                if (dayCount <= 0) {
