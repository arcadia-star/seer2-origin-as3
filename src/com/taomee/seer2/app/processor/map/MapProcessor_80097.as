...
public class MapProcessor_80097 extends MapProcessor {

    private static const FIGHT_INDEX:int = 753;

    private static const FIGHT_NUM_DAY:int = 903;

    private static const FIGHT_NUM_MI_BUY_FOR:int = 203536;
    ...
    public function MapProcessor_80097(param1:MapModel) {
        super(param1);
    }
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(663);
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(663, "希雅", [[0, "我这里倒是有一点你想要的东西！不如先比一下？"]], ["挑战吧！", "准备一下"], [function ():void {
