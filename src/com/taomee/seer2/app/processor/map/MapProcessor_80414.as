...
public class MapProcessor_80414 extends MapProcessor {

    private static const DAY_LIST:Array = [1656];

    private static const FOR_LIST:Array = [205694, 205699];

    private static const FIGHT_INDEX:int = 1532;

    private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605554]);
    ...
    public function MapProcessor_80414(param1:MapModel) {
        super(param1);
    }
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(810);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "神兽·朱雀";
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(810, "神兽·朱雀", [[0, "  接受烈焰的历练，你的意志将会如钢铁一般坚毅！决定向我挑战了吗，" + ActorManager.actorInfo.nick + "？"]], ["来吧，我准备好了！", "我还要再准备一下。"], [function ():void {
