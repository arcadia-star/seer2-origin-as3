...
public class MapProcessor_80083 extends MapProcessor {

    private static const FIGHT_INDEX:int = 723;

    private static const FIGHT_NUM_DAY:int = 881;

    private static const FIGHT_NUM_MI_BUY_FOR:int = 203449;
    ...
    public function MapProcessor_80083(param1:MapModel) {
        super(param1);
    }
    ...
    private function createNpc():void {
        if (!this._npc) {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(667);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "艾妮维亚";
    ...
    private function onNpcClick(param1:MouseEvent):void {
        ...
        NpcDialog.show(667, "艾妮维亚", [[0, "灵朱雀等候你多时，圣火守护，赢者传承！"]], ["挑战吧！", "准备一下"], [function ():void {
