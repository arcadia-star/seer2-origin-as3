package com.taomee.seer2.app.home.data
{
   ...
   public class HomeInfo
   {
      ...
      private var _trainingPetInfoVec:Vector.<TrainingPetInfo>;
      ...
      public var decorateInfo:DecorateInfo;
      
      public var nextyearActivityInfo:NextyearActivityInfo;
      ...
      {
         var _loc6_:TrainingPetInfo = null;
         this._leftFightCount = param1.readUnsignedByte();
         var _loc2_:int = int(param1.readUnsignedInt());
         this._trainingPetInfoVec = new Vector.<TrainingPetInfo>();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            (_loc6_ = new TrainingPetInfo(param1)).maxHp = param1.readUnsignedInt();
         ...
         this.decorateInfo = new DecorateInfo(param1);
      ...
      public function get trainingPetInfoVec() : Vector.<TrainingPetInfo>
      {
         return this._trainingPetInfoVec.concat();
      }
      
      public function addTrainingPetInfo(param1:TrainingPetInfo) : void
      {
      ...
      private function isAlreadyExist(param1:TrainingPetInfo) : Boolean
      {
         var _loc2_:TrainingPetInfo = null;
