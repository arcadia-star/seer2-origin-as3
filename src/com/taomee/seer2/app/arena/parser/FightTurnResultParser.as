      ...
      private function parseTurnResultInfo(param1:TurnResultInfo) : void
      {
         ...
         var showAtkerSkillInfo:Function = function(param1:uint):void
         {
            ...
            if(_loc2_ != null)
            {
               ...
               arenaUIController.entryValue("<font color=\'#00FF00\'>" + atker.fighterInfo.name + ":" + "</font>" + "<font color=\'#00FFFF\'>" + "使用技能" + "</font>" + "<font color=\'#FF0000\'>" + _loc2_.name + "</font>");
            }
            else
            {
         ...
         var getBurstList:Function = function(param1:uint):Array
         {
            ...
            switch(param1)
            {
               case 2:
                  ...
                  break;
               case 3:
                  _loc2_ = [0.25,0.15,0.6];
                  break;
               case 4:
                  _loc2_ = [0.15,0.2,0.25,0.4];
                  break;
               case 5:
                  _loc2_ = [0.1,0.13,0.07,0.3,0.4];
                  break;
               case 6:
                  _loc2_ = [0.05,0.1,0.05,0.2,0.25,0.35];
                  break;
               case 7:
                  _loc2_ = [0.03,0.07,0.1,0.15,0.17,0.23,0.25];
                  break;
               case 8:
                  _loc2_ = [0.03,0.07,0.1,0.15,0.17,0.13,0.05,0.3];
                  break;
               case 9:
                  _loc2_ = [0.03,0.07,0.1,0.13,0.07,0.03,0.17,0.15,0.25];
                  break;
               case 10:
                  _loc2_ = [0.05,0.17,0.03,0.05,0.03,0.07,0.03,0.17,0.15,0.25];
                  break;
               case 11:
                  _loc2_ = [0.02,0.08,0.06,0.14,0.05,0.05,0.15,0.05,0.03,0.07,0.3];
                  break;
               case 12:
                  _loc2_ = [0.03,0.04,0.03,0.07,0.03,0.1,0.2,0.1,0.1,0.03,0.07,0.2];
                  break;
               case 13:
                  _loc2_ = [0.04,0.05,0.11,0.03,0.07,0.06,0.04,0.15,0.05,0.1,0.1,0.05,0.15];
                  break;
               case 14:
                  _loc2_ = [0.15,0.05,0.11,0.09,0.03,0.03,0.04,0.05,0.05,0.06,0.04,0.03,0.04,0.23];
                  break;
               case 15:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.3];
                  break;
               case 16:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.1,0.2];
                  break;
               case 17:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.07,0.03,0.2];
                  break;
               case 18:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.07,0.03,0.03,0.17];
                  break;
               case 19:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.07,0.03,0.03,0.04,0.13];
                  break;
               case 20:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.13];
                  break;
               case 21:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.07,0.03,0.06,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.11];
                  break;
               case 22:
                  _loc2_ = [0.03,0.04,0.05,0.05,0.03,0.15,0.05,0.02,0.03,0.06,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.11];
                  break;
               case 23:
                  _loc2_ = [0.03,0.04,0.03,0.05,0.03,0.15,0.05,0.02,0.03,0.03,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.06,0.11];
                  break;
               case 24:
                  _loc2_ = [0.03,0.04,0.03,0.05,0.03,0.15,0.03,0.02,0.03,0.03,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.06,0.02,0.11];
                  break;
               case 25:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.15,0.03,0.02,0.03,0.03,0.04,0.03,0.04,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.06,0.02,0.02,0.11];
                  break;
               case 26:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.15,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.11];
                  break;
               case 27:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.1,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.05,0.11];
                  break;
               case 28:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.07,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.05,0.03,0.11];
                  break;
               case 29:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.02,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.05,0.03,0.05,0.11];
                  break;
               case 30:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.02,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.04,0.03,0.04,0.02,0.11];
                  break;
               default:
                  _loc2_ = [0.03,0.02,0.03,0.05,0.03,0.02,0.03,0.02,0.03,0.03,0.04,0.03,0.02,0.03,0.06,0.02,0.03,0.02,0.03,0.02,0.05,0.05,0.02,0.02,0.03,0.04,0.03,0.04,0.02,0.11];
            }
