...
public class GudieArenaResourceLoadCMD7 implements IArenaBaseCMD {
    ...
    public function GudieArenaResourceLoadCMD7(param1:ArenaDataInfo, param2:Function) {
        super();
    ...
    public function send():void {
        ...
        _loc1_.writeUnsignedInt(825);
        _loc1_.writeByte(1);
        _loc1_.writeShort(60);
        _loc1_.writeUnsignedInt(500);
        _loc1_.writeUnsignedInt(500);
        _loc1_.writeUnsignedInt(5);
        _loc1_.writeUnsignedInt(16239);
        _loc1_.writeUnsignedInt(16240);
        _loc1_.writeUnsignedInt(16241);
        _loc1_.writeUnsignedInt(16242);
