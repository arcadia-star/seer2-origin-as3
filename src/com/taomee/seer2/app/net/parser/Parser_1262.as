...
public class Parser_1262 {
    ...
    public var shoucangstarInfo:Vector.<StarInfo>;

    public function Parser_1262(param1:IDataInput) {
        var _loc2_:int = 0;
        var _loc3_:StarInfo = null;
        var _loc4_:int = 0;
        this.starInfo = new Vector.<StarInfo>();
        this.bagstarInfo = new Vector.<StarInfo>();
        this.shoucangstarInfo = new Vector.<StarInfo>();
        super();
        ...
        if (_loc2_ > 0) {
            ...
            while (_loc4_ < _loc2_) {
                ...
                _loc3_.type = param1.readUnsignedInt();
                _loc3_.buffSwf = param1.readUnsignedInt();
                this.shoucangstarInfo.push(_loc3_);
                _loc4_++;
            }
        }
    }
