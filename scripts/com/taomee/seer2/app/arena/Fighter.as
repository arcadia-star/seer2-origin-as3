package com.taomee.seer2.app.arena
{
   ...
   public class Fighter extends AnimateElement
   {
      ...
      private var _fighterAnimation:com.taomee.seer2.app.arena.FighterAnimation;
      ...
      override public function set action(param1:String) : void
      {
         ...
         this._fighterAnimation.addEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_END,this.onActionEnd);
         this._fighterAnimation.addEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_HIT,this.onHit);
      ...
      public function active() : void
      {
         ...
         if(this._fighterAnimation == null)
         {
            this._fighterAnimation = new com.taomee.seer2.app.arena.FighterAnimation();
      ...
      {
         this._fighterAnimation.removeEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_HIT,this.onHit);
      ...
      private function onActionEnd(param1:Event) : void
      {
         ...
         if(this._fighterAnimation.hasEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_HIT))
         {
            this._fighterAnimation.removeEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_HIT,this.onHit);
         }
         this._fighterAnimation.removeEventListener(com.taomee.seer2.app.arena.FighterAnimation.EVT_END,this.onActionEnd);
         this.dispatchActionEvent(FighterEvent.ACTION_END);
      }
      ...
      public function get fighterAnimation() : com.taomee.seer2.app.arena.FighterAnimation
      {
