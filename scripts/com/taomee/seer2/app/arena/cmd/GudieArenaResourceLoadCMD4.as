package com.taomee.seer2.app.arena.cmd
{
   ...
   public class GudieArenaResourceLoadCMD4 implements IArenaBaseCMD
   {
      ...
      public function send() : void
      {
         ...
         _loc1_.writeUnsignedInt(830);
         _loc1_.writeByte(1);
         _loc1_.writeShort(60);
         _loc1_.writeUnsignedInt(500);
         _loc1_.writeUnsignedInt(500);
         _loc1_.writeUnsignedInt(5);
         _loc1_.writeUnsignedInt(16317);
         _loc1_.writeUnsignedInt(16318);
         _loc1_.writeUnsignedInt(16319);
         _loc1_.writeUnsignedInt(16320);
