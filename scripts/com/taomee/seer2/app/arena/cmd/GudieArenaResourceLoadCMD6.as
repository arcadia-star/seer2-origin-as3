package com.taomee.seer2.app.arena.cmd
{
   ...
   public class GudieArenaResourceLoadCMD6 implements IArenaBaseCMD
   {
      ...
      public function GudieArenaResourceLoadCMD6(param1:ArenaDataInfo, param2:Function)
      {
         super();
      ...
      public function send() : void
      {
         ...
         _loc1_.writeUnsignedInt(10035);
         _loc1_.writeUnsignedInt(10036);
         _loc1_.writeUnsignedInt(10037);
         _loc1_.writeUnsignedInt(0);
         _loc1_.writeUnsignedInt(0);
         _loc1_.writeByte(0);
         _loc1_.writeByte(0);
