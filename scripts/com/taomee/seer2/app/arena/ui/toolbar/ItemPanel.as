   ...
   internal class ItemPanel extends Sprite
   {
      ...
      private function addGudie() : void
      {
         if(this._filterType == PetItemType.PHYSICAL_MEDICINE)
         {
            ...
            GuideManager.instance.addGuide2Target(this._itemDisplayVec[0],0,2,new Point(100,470),true,false,GudieDirectionType.CONTENT);
         }
         else if(this._filterType == PetItemType.CAPSULE)
         {
            GuideManager.instance.addTarget(this._itemDisplayVec[0],5);
            GuideManager.instance.addGuide2Target(this._itemDisplayVec[0],0,5,new Point(100,470),true,true,GudieDirectionType.CONTENT);
         }
      }
