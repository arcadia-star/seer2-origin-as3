package com.taomee.seer2.app.arena.ui.status.panel
{
   ...
   public class FightStatusPanel extends Sprite
   {
      ...
      protected var _leftAngerStatus:com.taomee.seer2.app.arena.ui.status.panel.AngerStatusPanel;
      ...
      protected var _rightAngerStatus:com.taomee.seer2.app.arena.ui.status.panel.AngerStatusPanel;
      ...
      private function createAngerBar(param1:uint) : void
      {
         ...
         if(param1 == FightSide.LEFT)
         {
            if(ArenaUIIsNew.isNewUI)
            {
               this._leftAngerStatus = new com.taomee.seer2.app.arena.ui.status.panel.AngerStatusPanel(param1);
         ...
         else if(param1 == FightSide.RIGHT)
         {
            if(ArenaUIIsNew.isNewUI)
            {
               this._rightAngerStatus = new com.taomee.seer2.app.arena.ui.status.panel.AngerStatusPanel(param1);
