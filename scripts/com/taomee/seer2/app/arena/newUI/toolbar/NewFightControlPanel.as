package com.taomee.seer2.app.arena.newUI.toolbar
{
   ...
   public class NewFightControlPanel extends Sprite
   {
      ...
      private var _hubButtonPanel:com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel;
      ...
      private var _fighterPanel:com.taomee.seer2.app.arena.newUI.toolbar.NewFighterPanel;
      ...
      public function NewFightControlPanel()
      {
         ...
         this._fighterPanel = new com.taomee.seer2.app.arena.newUI.toolbar.NewFighterPanel();
         this._itemPanel = new NewItemPanel(PetItemType.PHYSICAL_MEDICINE);
         this._capsulePanel = new NewItemPanel(PetItemType.CAPSULE);
         this._hubButtonPanel = new com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel();
         addChild(this._hubButtonPanel);
         this._changPet = this._back["changPet"];
         this._changPet.visible = false;
         this._hubButtonPanel.addEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_FIGHT,this.onFightClick);
         this._hubButtonPanel.addEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_ITEM,this.onItemClick);
         this._hubButtonPanel.addEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_PET,this.onPetClick);
         this._hubButtonPanel.addEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_ESCAPE,this.onEscapeClick);
         this._hubButtonPanel.addEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_CATCH,this.onCatchClick);
      ...
      public function getHubButtonPanel() : com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel
      {
      ...
      public function dispose() : void
      {
         ...
         this._hubButtonPanel.removeEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_FIGHT,this.onFightClick);
         this._hubButtonPanel.removeEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_ITEM,this.onItemClick);
         this._hubButtonPanel.removeEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_PET,this.onPetClick);
         this._hubButtonPanel.removeEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_ESCAPE,this.onEscapeClick);
         this._hubButtonPanel.removeEventListener(com.taomee.seer2.app.arena.newUI.toolbar.NewHubButtonPanel.EVT_CATCH,this.onCatchClick);
