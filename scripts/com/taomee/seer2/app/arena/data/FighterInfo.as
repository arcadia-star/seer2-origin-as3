package com.taomee.seer2.app.arena.data
{
   ...
   public class FighterInfo
   {
      ...
      private var _fightBuffInfoVec:Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>;
      
      public function FighterInfo(param1:uint, param2:IDataInput)
      {
         this._fightBuffInfoVec = new Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>();
         super();
         this._userId = param1;
      ...
      public function set fightBuffInfoVec(param1:Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>) : void
      {
         this._fightBuffInfoVec = param1;
      }
      
      public function get fightBuffInfoVec() : Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>
      {
