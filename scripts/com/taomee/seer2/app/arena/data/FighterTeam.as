package com.taomee.seer2.app.arena.data
{
   ...
   public class FighterTeam
   {
      ...
      private var _teamInfo:com.taomee.seer2.app.arena.data.TeamInfo;
      
      private var _fighterVec:Vector.<Fighter>;
      
      private var _fighterInfoVec:Vector.<com.taomee.seer2.app.arena.data.FighterInfo>;
      
      private var _changeFighterVec:Vector.<Fighter>;
      
      private var _changeFighterInfoVec:Vector.<com.taomee.seer2.app.arena.data.FighterInfo>;
      
      private var _initFighterVec:Vector.<Fighter>;
      
      public function FighterTeam(param1:com.taomee.seer2.app.arena.data.TeamInfo)
      {
         var _loc2_:FightUserInfo = null;
         var _loc3_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         var _loc4_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         super();
         this._teamInfo = param1;
         this._fighterVec = new Vector.<Fighter>();
         this._fighterInfoVec = new Vector.<com.taomee.seer2.app.arena.data.FighterInfo>();
         this._changeFighterVec = new Vector.<Fighter>();
         this._changeFighterInfoVec = new Vector.<com.taomee.seer2.app.arena.data.FighterInfo>();
      ...
      public function createFighter(param1:ResourceQueue, param2:ArenaDataInfo) : void
      {
         ...
         var _loc4_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         var _loc5_:com.taomee.seer2.app.arena.data.FighterInfo = null;
      ...
      public function getRandomAliveFighterInfo() : com.taomee.seer2.app.arena.data.FighterInfo
      {
         var _loc1_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         var _loc2_:com.taomee.seer2.app.arena.data.FighterInfo = null;
      ...
      public function get mainFighterInfo() : com.taomee.seer2.app.arena.data.FighterInfo
      {
         var _loc1_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         var _loc2_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         for each(_loc2_ in this._fighterInfoVec)
      ...
      public function get subFighterInfo() : com.taomee.seer2.app.arena.data.FighterInfo
      {
         var _loc1_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         var _loc2_:com.taomee.seer2.app.arena.data.FighterInfo = null;
         for each(_loc2_ in this._fighterInfoVec)
      ...
      public function get teamInfo() : com.taomee.seer2.app.arena.data.TeamInfo
      {
      ...
      public function isFitInfo(param1:com.taomee.seer2.app.arena.data.FighterInfo) : Boolean
      {
