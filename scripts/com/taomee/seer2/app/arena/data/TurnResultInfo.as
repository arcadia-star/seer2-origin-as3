package com.taomee.seer2.app.arena.data
{
   ...
   public class TurnResultInfo
   {
      ...
      private var _fighterTurnResultInfoVec:Vector.<com.taomee.seer2.app.arena.data.FighterTurnResultInfo>;
      
      private var _skillTypeDelation:uint;
      
      public function TurnResultInfo(param1:IDataInput)
      {
         var _loc3_:com.taomee.seer2.app.arena.data.FighterTurnResultInfo = null;
         var _loc5_:FighterBuffInfo = null;
         super();
         this._fighterTurnResultInfoVec = new Vector.<com.taomee.seer2.app.arena.data.FighterTurnResultInfo>();
         var _loc2_:int = int(param1.readUnsignedInt());
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_ = new com.taomee.seer2.app.arena.data.FighterTurnResultInfo(param1);
      ...
      public function get fighterTurnResultInfoVec() : Vector.<com.taomee.seer2.app.arena.data.FighterTurnResultInfo>
      {
