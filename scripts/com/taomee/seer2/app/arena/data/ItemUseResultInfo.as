package com.taomee.seer2.app.arena.data
{
   ...
   public class ItemUseResultInfo
   {
      ...
      private var _buffInfoVec:Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>;
      ...
      public function ItemUseResultInfo(param1:IDataInput)
      {
         ...
         this._buffInfoVec = new Vector.<com.taomee.seer2.app.arena.data.FighterBuffInfo>();
         var _loc2_:uint = uint(param1.readUnsignedInt());
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            this._buffInfoVec.push(new com.taomee.seer2.app.arena.data.FighterBuffInfo(param1));
            _loc3_++;
         }
      }
