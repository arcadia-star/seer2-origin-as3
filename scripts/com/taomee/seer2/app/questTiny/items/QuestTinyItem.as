package com.taomee.seer2.app.questTiny.items
{
   ...
   public class QuestTinyItem extends TreeItem
   {
      ...
      private static var _instanceVec:Vector.<com.taomee.seer2.app.questTiny.items.QuestTinyItem> = new Vector.<com.taomee.seer2.app.questTiny.items.QuestTinyItem>();
      ...
      private static function addInstance(param1:com.taomee.seer2.app.questTiny.items.QuestTinyItem) : void
      {
         _instanceVec.push(param1);
      }
      
      private static function updateSelection(param1:com.taomee.seer2.app.questTiny.items.QuestTinyItem) : void
      {
         var _loc2_:com.taomee.seer2.app.questTiny.items.QuestTinyItem = null;
      ...
      {
         var _loc1_:com.taomee.seer2.app.questTiny.items.QuestTinyItem = null;
