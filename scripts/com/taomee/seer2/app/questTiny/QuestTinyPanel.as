package com.taomee.seer2.app.questTiny
{
   ...
   public class QuestTinyPanel extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.questTiny.QuestTinyPanel;
      ...
      private var _navigationView:com.taomee.seer2.app.questTiny.QuestTinyNavigationView;
      ...
      public static function get instance() : com.taomee.seer2.app.questTiny.QuestTinyPanel
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.questTiny.QuestTinyPanel();
         }
         return _instance;
      }
      ...
      private function setup() : void
      {
         ...
         _mainUI.y = 140;
         addChild(_mainUI);
         this._navigationView = new com.taomee.seer2.app.questTiny.QuestTinyNavigationView(_mainUI["navigation"]);
