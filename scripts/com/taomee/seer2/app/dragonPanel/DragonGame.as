package com.taomee.seer2.app.dragonPanel
{
   ...
   public class DragonGame
   {
      ...
      private static var _fishGameMain:com.taomee.seer2.app.dragonPanel.DragonGameStart;
      ...
      public static function createGame() : void
      {
         ...
         _fishGameMain = new com.taomee.seer2.app.dragonPanel.DragonGameStart(_libs,_count);
