package com.taomee.seer2.app.actives
{
   ...
   public class TongHunFight
   {
      ...
      private static var _instance:com.taomee.seer2.app.actives.TongHunFight;
      ...
      public static function getInstance() : com.taomee.seer2.app.actives.TongHunFight
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.actives.TongHunFight();
         }
         return _instance;
      }
      ...
      {
         var _loc2_:int = this.monsterList.indexOf(param1.target);
