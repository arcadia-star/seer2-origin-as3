package com.taomee.seer2.app.actives
{
   ...
   public class ShengJiaDiLeiAct
   {
      ...
      private static var _instance:com.taomee.seer2.app.actives.ShengJiaDiLeiAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.actives.ShengJiaDiLeiAct
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.actives.ShengJiaDiLeiAct();
         }
         return _instance;
      }
      ...
      {
         ActiveCountManager.requestActiveCount(this.buy_turn_id,function(param1:uint, param2:int):void
         {
