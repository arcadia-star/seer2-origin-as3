package com.taomee.seer2.app.actives
{
   ...
   public class QingFengBaiDiAct
   {
      ...
      private static var _instance:com.taomee.seer2.app.actives.QingFengBaiDiAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.actives.QingFengBaiDiAct
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.actives.QingFengBaiDiAct();
         }
         return _instance;
      }
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function callBack(param1:DayLimitListInfo):void
            {
               ...
               if(SceneManager.prevSceneType == SceneType.ARENA && FightManager.currentFightRecord.initData.positionIndex == FIGHT_BOSS_ID)
               {
                  if(FightManager.fightWinnerSide == FightSide.LEFT)
                  {
                     ...
                     {
                        ServerBufferManager.updateServerBuffer(ServerBufferType.QINGFENGBAIDI_FIRST_FIGHT,1,0);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            ServerBufferManager.getServerBuffer(ServerBufferType.QINGFENGBAIDI_FIRST_FIGHT,function(param1:ServerBuffer):void
            {
               var _loc2_:Boolean = Boolean(param1.readDataAtPostion(1));
               if(!_loc2_)
               {
                  ServerBufferManager.updateServerBuffer(ServerBufferType.QINGFENGBAIDI_FIRST_FIGHT,1,1);
