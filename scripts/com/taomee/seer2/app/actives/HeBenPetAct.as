package com.taomee.seer2.app.actives
{
   ...
   public class HeBenPetAct
   {
      
      private static var _instance:com.taomee.seer2.app.actives.HeBenPetAct;
       
      
      private const ITEM_ID:Array = [500565,500566,500567,500568,500569];
      
      private const maxBloodNum:uint = 1300000;
      
      private const turnId:uint = 202312;
      
      private const hurtId:int = 202315;
      
      private const defaultBloodWidth:int = 168;
      
      private const fightIndex:uint = 463;
      
      private var exitMapSwapId:int = 1508;
      ...
      public function HeBenPetAct()
      {
         super();
      }
      
      public static function getInstance() : com.taomee.seer2.app.actives.HeBenPetAct
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.actives.HeBenPetAct();
         }
         return _instance;
      }
      ...
      public function dispose() : void
      {
         ...
         ModuleManager.removeEventListener("HeBenHurtAlertPanel",ModuleEvent.DISPOSE,this.closeAlert);
         ModuleManager.removeEventListener("HeBenBuyPanel",ModuleEvent.DISPOSE,this.closeBuy);
         if(!this.isToFight)
         {
      ...
      private function createNpc() : void
      {
         ...
         this._npc.resourceUrl = URLUtil.getActivityMobile("BossHeben");
      ...
      {
         ModuleManager.addEventListener("HeBenBuyPanel",ModuleEvent.DISPOSE,this.closeBuy);
         ModuleManager.toggleModule(URLUtil.getAppModule("HeBenBuyPanel"));
      }
      ...
      {
         ModuleManager.addEventListener("HeBenHurtAlertPanel",ModuleEvent.DISPOSE,this.closeAlert);
         ModuleManager.toggleModule(URLUtil.getAppModule("HeBenHurtAlertPanel"),"",{
            "hurt":this.hurtValue,
      ...
      private function getNewInfo(param1:Parser_1142) : void
      {
         ...
         if(this.leftBlood <= 0)
         {
            SwapManager.swapItem(this.exitMapSwapId,1,this.closeSwap);
         }
      }
      ...
      private function checkItem(param1:ItemEvent) : void
      {
         ...
         while(_loc2_ < this.ITEM_ID.length)
         {
            ...
            {
               this.itemTxt.text = "当前荣耀:" + ItemConfig.getItemDefinition(this.ITEM_ID[_loc2_]).tip;
               break;
            }
