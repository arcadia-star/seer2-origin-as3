package com.taomee.seer2.app.component
{
   ...
   public class TeamLogoDisplayer extends Sprite
   {
      ...
      private var _frontDisplayer:com.taomee.seer2.app.component.IconDisplayer;
      
      private var _backDisplayer:com.taomee.seer2.app.component.IconDisplayer;
      ...
      {
         this._backDisplayer = new com.taomee.seer2.app.component.IconDisplayer();
         this._backDisplayer.scaleX = this._backDisplayer.scaleY = 1.5;
         addChild(this._backDisplayer);
         this._frontDisplayer = new com.taomee.seer2.app.component.IconDisplayer();
