package com.taomee.seer2.app.component
{
   ...
   public class Combobox extends Sprite
   {
      ...
      private var _listScroller:com.taomee.seer2.app.component.Scroller;
      ...
      private function initView() : void
      {
         ...
         this._listScroller = new com.taomee.seer2.app.component.Scroller(this._listMc["scroller"]);
      ...
      public function addScrollerListener(param1:Function) : void
      {
         ...
         this._listScroller.addEventListener(com.taomee.seer2.app.component.Scroller.END,this.updateItmeInfo);
         this._listScroller.addEventListener(com.taomee.seer2.app.component.Scroller.MOVE,this.updateItmeInfo);
      }
