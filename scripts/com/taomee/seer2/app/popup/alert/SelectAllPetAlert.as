package com.taomee.seer2.app.popup.alert
{
   ...
   public class SelectAllPetAlert extends Sprite implements IAlert
   {
      ...
      public function SelectAllPetAlert()
      {
         super();
         this.setup();
      }
      ...
      {
         this.setMainUI(UIManager.getMovieClip("UI_SelectAllPet"));
      ...
      private function createPets() : void
      {
         ...
         this._petInfoVec = PetInfoManager.getTotalBagPetInfo();
         var _loc2_:uint = 0;
         while(_loc2_ < 12)
         {
