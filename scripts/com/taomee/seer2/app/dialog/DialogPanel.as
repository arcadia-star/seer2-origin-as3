package com.taomee.seer2.app.dialog
{
   ...
   public class DialogPanel extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.dialog.DialogPanel;
      ...
      private var _dialogBox:com.taomee.seer2.app.dialog.DialogBox;
      
      private var _functionalityBox:com.taomee.seer2.app.dialog.FunctionalityBox;
      ...
      private var dialogPanel:com.taomee.seer2.app.dialog.DialogPanel;
      ...
      public static function get dialogBox() : com.taomee.seer2.app.dialog.DialogBox
      {
      ...
      private static function get instance() : com.taomee.seer2.app.dialog.DialogPanel
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.dialog.DialogPanel();
         }
         return _instance;
      }
      ...
      public static function get functionalityBox() : com.taomee.seer2.app.dialog.FunctionalityBox
      {
      ...
      {
         this._dialogBox = new com.taomee.seer2.app.dialog.DialogBox();
      ...
      {
         this._functionalityBox = new com.taomee.seer2.app.dialog.FunctionalityBox();
