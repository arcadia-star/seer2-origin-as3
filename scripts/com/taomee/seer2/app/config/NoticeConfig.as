package com.taomee.seer2.app.config
{
   ...
   public class NoticeConfig
   {
      ...
      private static var _instance:com.taomee.seer2.app.config.NoticeConfig;
      ...
      public static function get Instance() : com.taomee.seer2.app.config.NoticeConfig
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.config.NoticeConfig();
         }
         return _instance;
      }
      ...
      private function loadConfig() : void
      {
         if(!this._isLoaded && !this._isLoading)
         {
            ...
            QueueLoader.load(URLUtil.getActivityXML("activity_notice"),LoadType.TEXT,this.onComplete);
         }
      }
