package com.taomee.seer2.app.config
{
   ...
   public class WebJumpConfig
   {
      ...
      private static var _instance:com.taomee.seer2.app.config.WebJumpConfig;
      ...
      public static function get Instance() : com.taomee.seer2.app.config.WebJumpConfig
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.config.WebJumpConfig();
         }
         return _instance;
      }
