package com.taomee.seer2.app.config
{
   ...
   public class ActivityConfig
   {
      ...
      private static function addTimeActivity(param1:uint, param2:String, param3:int, param4:XML) : void
      {
         ...
         var _loc5_:String;
         var _loc6_:Array = (_loc5_ = (_loc5_ = param4.@circleDate).replace(/ /g,"")).split(",");
         var _loc7_:Array = new Array();
         var _loc8_:Array = new Array();
         var _loc9_:XMLList = param4.descendants("phase");
         for each(_loc10_ in _loc9_)
         {
            _loc13_ = (_loc12_ = (_loc12_ = String(_loc10_.@value)).replace(/ /g,"")).split(",");
            for each(_loc11_ in _loc13_)
            {
               _loc7_.push(_loc11_);
            }
            _loc13_ = (_loc14_ = (_loc14_ = _loc10_.@detail).replace(/ /g,"")).split(",");
            for each(_loc11_ in _loc13_)
            {
               _loc8_.push(_loc11_);
            }
