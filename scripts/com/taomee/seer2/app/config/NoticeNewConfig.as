package com.taomee.seer2.app.config
{
   ...
   public class NoticeNewConfig
   {
      ...
      private static var _instance:com.taomee.seer2.app.config.NoticeNewConfig;
      ...
      public static function get Instance() : com.taomee.seer2.app.config.NoticeNewConfig
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.config.NoticeNewConfig();
         }
         return _instance;
      }
