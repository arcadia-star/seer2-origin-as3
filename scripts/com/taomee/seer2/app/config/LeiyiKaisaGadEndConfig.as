package com.taomee.seer2.app.config
{
   ...
   public class LeiyiKaisaGadEndConfig
   {
      ...
      private static var _instance:com.taomee.seer2.app.config.LeiyiKaisaGadEndConfig;
      ...
      public static function get Instance() : com.taomee.seer2.app.config.LeiyiKaisaGadEndConfig
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.config.LeiyiKaisaGadEndConfig();
         }
         return _instance;
      }
