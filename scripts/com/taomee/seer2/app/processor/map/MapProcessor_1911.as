package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1911 extends MapProcessor
   {
       
      
      public function MapProcessor_1911(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function getFightNum(param1:int, param2:int) : void
      {
         ...
         else
         {
            ...
            while(_loc3_ < 5)
            {
               _loc4_ = new SpawnedPet(20,253,0);
