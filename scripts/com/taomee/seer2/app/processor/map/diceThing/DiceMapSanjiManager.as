package com.taomee.seer2.app.processor.map.diceThing
{
   ...
   public class DiceMapSanjiManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.map.diceThing.DiceMapSanjiManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.map.diceThing.DiceMapSanjiManager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.processor.map.diceThing.DiceMapSanjiManager(new instancs());
         }
         return _instance;
      }
