package com.taomee.seer2.app.processor.map.diceThing
{
   ...
   public class DiceMapMeeManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.map.diceThing.DiceMapMeeManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.map.diceThing.DiceMapMeeManager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.processor.map.diceThing.DiceMapMeeManager(new instancs());
         }
         return _instance;
      }
