package com.taomee.seer2.app.processor.map.diceThing
{
   ...
   public class DiceMapLuffyManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.map.diceThing.DiceMapLuffyManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.map.diceThing.DiceMapLuffyManager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.processor.map.diceThing.DiceMapLuffyManager(new instancs());
         }
         return _instance;
      }
