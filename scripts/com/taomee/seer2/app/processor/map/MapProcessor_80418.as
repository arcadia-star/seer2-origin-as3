package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80418 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1666];
      
      private static const FOR_LIST:Array = [205723,205728];
      
      private static const FIGHT_INDEX:int = 1538;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605575]);
      ...
      public function MapProcessor_80418(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(880);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "武道修罗";
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(880,"武道修罗",[[0,"看来你的精灵已经有能够战胜冥神的系别了，不过可别高兴的太早，还必须经过我的考验才能见到洛王。"]],["什么考验我都不怕！","等我准备一下就回来"],[function():void
         {
