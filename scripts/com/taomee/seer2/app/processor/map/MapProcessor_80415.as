package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80415 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [205697,205695,205699,205696];
      
      private static const DAY_LIST:Array = [1657];
      
      private static const FIGHT_INDEX:int = 1533;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605556,500626,605555]);
      ...
      public function MapProcessor_80415(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function onHurtBuy(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            {
               AlertManager.showAlert("你已经有焰王荣耀了,快去战斗吧!");
            }
            else
            {
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(878);
