package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80235 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1260];
      
      private static const FIGHT_INDEX:int = 1133;
      ...
      public function MapProcessor_80235(param1:MapModel)
      {
         super(param1);
      }
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               if(canFightNum > 0)
               {
                  ...
                  else
                  {
                     ...
                     {
                        ModuleManager.showAppModule("BlackGetFireMainPanel");
                     });
                  }
               }
               else
