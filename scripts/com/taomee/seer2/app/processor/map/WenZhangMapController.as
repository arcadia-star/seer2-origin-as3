package com.taomee.seer2.app.processor.map
{
   ...
   public class WenZhangMapController
   {
      ...
      private static var myClass:com.taomee.seer2.app.processor.map.WenZhangMapController;
      ...
      {
         super();
         if(com.taomee.seer2.app.processor.map.WenZhangMapController.myClass !== null)
         {
            throw new Error("WenZhangMapController是单例类");
         }
      }
      
      public static function getInstance() : com.taomee.seer2.app.processor.map.WenZhangMapController
      {
         if(myClass == null)
         {
            myClass = new com.taomee.seer2.app.processor.map.WenZhangMapController();
         }
         return myClass;
      }
