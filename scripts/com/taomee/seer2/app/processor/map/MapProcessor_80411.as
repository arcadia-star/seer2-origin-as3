package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80411 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [205683,205681,205685,205682];
      
      private static const DAY_LIST:Array = [1648];
      
      private static const FIGHT_INDEX:int = 1525;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605539,500625,605538]);
      ...
      public function MapProcessor_80411(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function onHurtBuy(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            {
               AlertManager.showAlert("你已经有尘王荣耀了,快去战斗吧!");
            }
            else
            {
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(875);
