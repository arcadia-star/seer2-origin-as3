package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80495 extends MapProcessor
   {
       
      
      public function MapProcessor_80495(param1:MapModel)
      {
         super(param1);
      }
      ...
      {
         ModuleManager.showAppModule("DespairTowerSecondSeasonMainPanel");
      }
