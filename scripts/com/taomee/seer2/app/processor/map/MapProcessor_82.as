package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_82 extends TitleMapProcessor
   {
      ...
      public function MapProcessor_82(param1:MapModel)
      {
      ...
      override public function init() : void
      {
         ...
         ActorManager.getActor().x = 422;
         ActorManager.getActor().y = 416;
         var _loc1_:LobbyScene = SceneManager.active as LobbyScene;
         _loc1_.showToolbar();
         ActorManager.showRemoteActor = true;
         var _loc2_:Sprite = _map.content;
         this._doors.push(new TrailDoor(_loc2_["leftPassage"],DoorType.Door_NORMAL));
         this._doors.push(new TrailDoor(_loc2_["rightPassage"],DoorType.Door_50V50));
         StatisticsManager.sendNovice(StatisticsManager.ui_interact_198);
      }
