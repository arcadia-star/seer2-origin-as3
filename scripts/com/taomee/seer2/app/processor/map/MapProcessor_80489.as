package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80489 extends MapProcessor
   {
      ...
      private static const NPC_ID:int = 3049;
      ...
      public function MapProcessor_80489(param1:MapModel)
      {
         super(param1);
      }
      ...
      {
         if((param1.content as DialogPanelEventData).params == "haoJieDevilToFight")
         {
         ...
         else if((param1.content as DialogPanelEventData).params == "haoJieDevilSeeRank")
         {
