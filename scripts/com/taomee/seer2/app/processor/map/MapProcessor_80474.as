package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80474 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [205857,205854,205856,205863];
      
      private static const DAY_LIST:Array = [1724];
      
      private static const FIGHT_INDEX:int = 1616;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605887,500630,605890]);
      
      private static const FIGHT_NUM_RULE:Vector.<int> = Vector.<int>([1,2]);
      
      private static const TIP_POS:Point = new Point(595,130);
      ...
      public function MapProcessor_80474(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function onHurtBuy(param1:MouseEvent) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            if(_par.infoVec[3] > 0)
            {
               AlertManager.showAlert("究极荣耀使用完再来购买吧!");
            }
            else
            {
               AlertManager.showConfirm("你确定花费" + ShopPanelConfig.getItemPrice(MI_ID_LIST[1]) + "星钻购买究极荣耀吗?",function():void
               {
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.setPostion(new Point(595,384));
            this._npc.resourceUrl = URLUtil.getNpcSwf(903);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "神圣界王神";
