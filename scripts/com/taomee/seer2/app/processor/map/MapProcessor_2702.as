package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_2702 extends MapProcessor
   {
       
      
      public function MapProcessor_2702(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function getFightNum() : void
      {
         ...
         while(_loc1_ < 5)
         {
            _loc2_ = new SpawnedPet(38,266,0);
