package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_83 extends TitleMapProcessor
   {
      ...
      public function MapProcessor_83(param1:MapModel)
      {
      ...
      override public function init() : void
      {
         ...
         ActorManager.getActor().x = 423;
         ActorManager.getActor().y = 385;
