package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80215 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [204334,204322];
      
      private static const DAY_LIST:Array = [1201];
      
      private static const FIGHT_INDEX:Vector.<uint> = Vector.<uint>([1034,1035,1036,1037]);
      
      private static const LAST_TIME:int = 300;
      
      private static const RES_ID:int = 508;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([603924]);
      ...
      public function MapProcessor_80215(param1:MapModel)
      {
         super(param1);
      }
