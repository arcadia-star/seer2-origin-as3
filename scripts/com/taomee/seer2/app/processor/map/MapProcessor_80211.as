package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80211 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1168];
      
      private static const FOR_LIST:Array = [204278,204275];
      
      private static const FIGHT_INDEX:int = 1017;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([603887]);
      ...
      public function MapProcessor_80211(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.setPostion(new Point(140,384));
