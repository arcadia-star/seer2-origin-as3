package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80098 extends MapProcessor
   {
      
      private static const FIGHT_INDEX:int = 754;
      
      private static const FIGHT_NUM_DAY:int = 904;
      
      private static const FIGHT_NUM_MI_BUY_FOR:int = 203537;
      ...
      public function MapProcessor_80098(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(664,"伯德",[[0,"我这里倒是有一点你想要的东西！不如先比一下？"]],["挑战吧！","准备一下"],[function():void
         {
