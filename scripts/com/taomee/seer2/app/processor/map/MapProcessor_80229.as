package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80229 extends MapProcessor
   {
      
      private static const FOR_LIST:Array = [204428,204426];
      
      private static const DAY_LIST:Array = [1241];
      
      private static const FIGHT_INDEX:Vector.<uint> = Vector.<uint>([1101,1102,1103,1104]);
      
      private static const LAST_TIME:int = 300;
      
      private static const RES_ID:int = 627;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([604003]);
      ...
      public function MapProcessor_80229(param1:MapModel)
      {
         super(param1);
      }
