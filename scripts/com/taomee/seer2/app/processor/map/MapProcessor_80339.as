package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80339 extends MapProcessor
   {
      
      private static const DAY_LIST:Array = [1445];
      
      private static const FOR_LIST:Array = [205062,205065];
      
      private static const FIGHT_INDEX:int = 1335;
      
      private static const MI_ID_LIST:Vector.<uint> = Vector.<uint>([605128]);
      ...
      public function MapProcessor_80339(param1:MapModel)
      {
         super(param1);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(825);
            this._npc.labelPosition = MobileLabelPosition.OVER_HEAD;
            this._npc.label = "圣冰十尾";
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(825,"圣冰十尾",[[0,"这不是幻觉，我就是你的期盼！接受圣冰的洗礼吧！"]],["开始挑战","准备一下"],[function():void
         {
