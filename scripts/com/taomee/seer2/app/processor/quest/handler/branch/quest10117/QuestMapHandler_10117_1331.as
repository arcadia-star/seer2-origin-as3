package com.taomee.seer2.app.processor.quest.handler.branch.quest10117
{
   ...
   public class QuestMapHandler_10117_1331 extends QuestMapHandlerDream
   {
      ...
      private var findMc:com.taomee.seer2.app.processor.quest.handler.branch.quest10117.FindDifferentPanel;
      ...
      private function showFindPanel() : void
      {
         if(!this.findMc)
         {
            this.findMc = new com.taomee.seer2.app.processor.quest.handler.branch.quest10117.FindDifferentPanel(_processor.resLib.getMovieClip("findMc"),this.findComplete);
         }
         this.findMc.init();
