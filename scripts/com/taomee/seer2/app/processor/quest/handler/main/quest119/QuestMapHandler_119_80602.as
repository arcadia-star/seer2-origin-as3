package com.taomee.seer2.app.processor.quest.handler.main.quest119
{
   ...
   public class QuestMapHandler_119_80602 extends QuestMapHandler
   {
       
      
      public function QuestMapHandler_119_80602(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      {
         var e:* = param1;
         NpcDialog.showDialogsByText("quest/dialog/119/1.json",function():void
         {
            if(!QuestManager.isAccepted(_quest.id))
            {
               QuestManager.accept(_quest.id);
            }
            SceneManager.changeScene(SceneType.COPY,80603);
         },null);
      }
