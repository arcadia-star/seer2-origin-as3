package com.taomee.seer2.app.processor.quest.handler.branch.quest10158
{
   ...
   public class QuestMapHandler_10158_800 extends QuestMapHandler
   {
       
      
      public function QuestMapHandler_10158_800(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && SceneManager.prevSceneType == SceneType.ARENA && (FightManager.currentFightRecord.initData.positionIndex == 86 || FightManager.currentFightRecord.initData.positionIndex == 87))
         {
