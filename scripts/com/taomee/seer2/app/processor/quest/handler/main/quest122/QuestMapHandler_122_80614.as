package com.taomee.seer2.app.processor.quest.handler.main.quest122
{
   ...
   public class QuestMapHandler_122_80614 extends QuestMapHandler
   {
       
      
      public function QuestMapHandler_122_80614(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      {
         var e:* = param1;
         NpcDialog.showDialogsByText("quest/dialog/122/3.json",function():void
         {
            SceneManager.changeScene(SceneType.COPY,80615);
         },null);
      }
