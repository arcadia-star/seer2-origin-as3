package com.taomee.seer2.app.processor.quest.handler.activity.quest30054
{
   ...
   public class QuestMapHandler_30054_220 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_30054_220(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      private function onItem(param1:MouseEvent) : void
      {
         ...
         {
            this._count += 1;
            ServerBufferManager.updateServerBuffer(ServerBufferType.MAKE_TABARD_MATERIAL,2,this._count);
