package com.taomee.seer2.app.processor.quest.handler.branch.quest10243
{
   ...
   public class QuestMapHandler_10243_80322 extends QuestMapHandler
   {
       
      
      private var _mc10242_0:MovieClip;
      
      public function QuestMapHandler_10243_80322(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      {
         MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("10243_0"),function():void
         {
            initStep1();
            _mc10242_0 = _processor.resLib.getMovieClip("Mc10242_3");
            _map.content.addChild(_mc10242_0);
            _mc10242_0.gotoAndStop(_mc10242_0.totalFrames);
         });
      }
