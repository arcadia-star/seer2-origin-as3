package com.taomee.seer2.app.processor.quest.handler.branch.quest10125
{
   ...
   public class QuestMapHandler_10125_Mine extends QuestMapHandler
   {
      ...
      {
         this.yData = <mineport id="2" resId="2" name="黄色矿脉" pos="820,270" actorPos="800,270" limit="3" aniPos="0,0" serverConfigId="2"/>;
         this.bData = <mineport id="3" resId="1" name="蓝色矿脉" pos="550,220" actorPos="398,400" limit="3" serverConfigId="4"/>;
         this.rData = <mineport id="2" resId="3" name="红色矿脉" pos="710,415" actorPos="135,260" limit="3" serverConfigId="1"/>;
         super(param1);
      }
