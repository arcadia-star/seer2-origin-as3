package com.taomee.seer2.app.processor.activity.yiteFigthPve
{
   ...
   public class YiTeEndingGetInfo
   {
      ...
      private static var yiteEnding:com.taomee.seer2.app.processor.activity.yiteFigthPve.YiTeEndingGetInfo;
      ...
      {
         super();
         if(com.taomee.seer2.app.processor.activity.yiteFigthPve.YiTeEndingGetInfo.yiteEnding != null)
         {
            throw new Error("该类是单例类");
         }
      }
      
      public static function getInstance() : com.taomee.seer2.app.processor.activity.yiteFigthPve.YiTeEndingGetInfo
      {
         if(yiteEnding == null)
         {
            yiteEnding = new com.taomee.seer2.app.processor.activity.yiteFigthPve.YiTeEndingGetInfo();
         }
         return yiteEnding;
      }
