package com.taomee.seer2.app.processor.activity.moPetProcessAct
{
   ...
   public class MoFightAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.moPetProcessAct.MoFightAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.moPetProcessAct.MoFightAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.moPetProcessAct.MoFightAct();
         }
         return _self;
      }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("moPetProcessAct/MoFightAct"),LoadType.SWF,function(param1:ContentInfo):void
         {
      ...
      {
         ModuleManager.addEventListener("MoPetProcessHurtAlertPanel",ModuleEvent.DISPOSE,this.closeAlert);
      ...
      {
         ModuleManager.removeEventListener("MoPetProcessHurtAlertPanel",ModuleEvent.DISPOSE,this.closeAlert);
         this.updateTurns();
      }
