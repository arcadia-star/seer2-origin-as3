package com.taomee.seer2.app.processor.activity.kaXiuSiAct
{
   ...
   public class KaXiuSiAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.kaXiuSiAct.KaXiuSiAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.kaXiuSiAct.KaXiuSiAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.kaXiuSiAct.KaXiuSiAct();
         }
         return _self;
      }
