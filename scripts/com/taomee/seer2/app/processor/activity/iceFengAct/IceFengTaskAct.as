package com.taomee.seer2.app.processor.activity.iceFengAct
{
   ...
   public class IceFengTaskAct
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.activity.iceFengAct.IceFengTaskAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.iceFengAct.IceFengTaskAct
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.processor.activity.iceFengAct.IceFengTaskAct();
         }
         return _instance;
      }
