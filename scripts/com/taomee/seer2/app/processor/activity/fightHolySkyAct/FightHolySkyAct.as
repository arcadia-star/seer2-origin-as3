package com.taomee.seer2.app.processor.activity.fightHolySkyAct
{
   ...
   public class FightHolySkyAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.fightHolySkyAct.FightHolySkyAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.fightHolySkyAct.FightHolySkyAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.fightHolySkyAct.FightHolySkyAct();
         }
         return _self;
      }
      ...
      {
         this._index = this._eventPetList.indexOf(param1.currentTarget);
         if(this._index == 0)
         {
            this.handle0();
         }
