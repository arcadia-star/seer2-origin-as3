package com.taomee.seer2.app.processor.activity.moonWakeUpAct
{
   ...
   public class MoonWakeUpAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.moonWakeUpAct.MoonWakeUpAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.moonWakeUpAct.MoonWakeUpAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.moonWakeUpAct.MoonWakeUpAct();
         }
         return _self;
      }
