package com.taomee.seer2.app.processor.activity.holyPetProcessAct
{
   ...
   public class HolyFightAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.holyPetProcessAct.HolyFightAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.holyPetProcessAct.HolyFightAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.holyPetProcessAct.HolyFightAct();
         }
         return _self;
      }
