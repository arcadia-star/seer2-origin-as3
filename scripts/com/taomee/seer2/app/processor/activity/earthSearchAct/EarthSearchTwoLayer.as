package com.taomee.seer2.app.processor.activity.earthSearchAct
{
   ...
   public class EarthSearchTwoLayer
   {
      ...
      private var _curHandle:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoHandle;
      
      private var _npc:Mobile;
      
      private var _self:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoLayer;
      ...
      {
         this._type = param1[0];
         this._curHandle = new com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoHandle(param1[0]);
      ...
      public function set curHandle(param1:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoHandle) : void
      {
         this._curHandle = param1;
      }
      
      public function get curHandle() : com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoHandle
      {
