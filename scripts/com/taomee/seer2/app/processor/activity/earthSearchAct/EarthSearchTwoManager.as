package com.taomee.seer2.app.processor.activity.earthSearchAct
{
   ...
   public class EarthSearchTwoManager
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoManager;
      
      public static var isPassMC:Boolean = false;
       
      
      private var _obj:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoLayer;
      ...
      public static function inistance() : com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoManager
      {
         if(null == _self)
         {
            _self = new com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoManager();
         }
         return _self;
      }
      ...
      public function addObj(param1:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoLayer) : void
      {
         this._obj = param1;
