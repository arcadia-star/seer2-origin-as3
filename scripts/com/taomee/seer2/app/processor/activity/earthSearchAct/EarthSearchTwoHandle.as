package com.taomee.seer2.app.processor.activity.earthSearchAct
{
   ...
   public class EarthSearchTwoHandle
   {
       
      
      private const RES_LIST:Vector.<int> = Vector.<int>([758,642,779]);
      
      private const POS_INDEX:Vector.<int> = Vector.<int>([1420,1421,1422]);
      ...
      private var _main:com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoLayer;
      
      public function EarthSearchTwoHandle(param1:int)
      {
         super();
         this._type = param1;
      }
      ...
      public function initSet(param1:Array) : void
      {
         ...
         this._main = param1[2] as com.taomee.seer2.app.processor.activity.earthSearchAct.EarthSearchTwoLayer;
      ...
      public function completeHandle() : void
      {
         ...
         this.playSceneTalk("sceneTalk_" + this._type,function():void
         {
            ServerMessager.addMessage(["岩石阵","熔浆阵","对流阵"][_type - 1] + "挑战成功！");
            if(DialogPanel.functionalityBox.getUnit("对流阵挑战开始"))
            {
               DialogPanel.functionalityBox.removeUnit(DialogPanel.functionalityBox.getUnit("对流阵挑战开始"));
            }
         });
      ...
      private function timeShow(param1:int) : void
      {
         ...
         if(this._curLeaveTime > 0)
         {
            ...
            (this._timeMc["time"] as TextField).text = DateUtil.getMS(this._curLeaveTime);
         }
         else
         {
