package com.taomee.seer2.app.processor.activity.taTianAct
{
   ...
   public class TaTianAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.taTianAct.TaTianAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.taTianAct.TaTianAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.taTianAct.TaTianAct();
         }
         return _self;
      }
