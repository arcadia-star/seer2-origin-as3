package com.taomee.seer2.app.processor.activity.mascot
{
   ...
   public class Mascot2Actor extends Sprite
   {
      ...
      private var _teamInfo:com.taomee.seer2.app.processor.activity.mascot.Mascot2Info;
      ...
      public function Mascot2Actor()
      {
         ...
         this.idList = [5];
         super();
         this._teamInfo = new com.taomee.seer2.app.processor.activity.mascot.Mascot2Info();
      }
      ...
      public function get info() : com.taomee.seer2.app.processor.activity.mascot.Mascot2Info
      {
