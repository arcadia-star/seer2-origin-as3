package com.taomee.seer2.app.processor.activity.mascot
{
   ...
   public class MascotManager
   {
      ...
      private var _currActor:com.taomee.seer2.app.processor.activity.mascot.MascotActor;
      ...
      public function MascotManager(param1:uint, param2:uint, param3:MapModel)
      {
         ...
         this._thisActor = new com.taomee.seer2.app.processor.activity.mascot.MascotActor();
         this._currActor = new com.taomee.seer2.app.processor.activity.mascot.MascotActor();
