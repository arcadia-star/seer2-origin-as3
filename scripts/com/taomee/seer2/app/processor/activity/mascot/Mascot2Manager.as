package com.taomee.seer2.app.processor.activity.mascot
{
   ...
   public class Mascot2Manager
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.activity.mascot.Mascot2Manager;
       
      
      private var _currActor:com.taomee.seer2.app.processor.activity.mascot.Mascot2Actor;
      ...
      public static function get Instance() : com.taomee.seer2.app.processor.activity.mascot.Mascot2Manager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.processor.activity.mascot.Mascot2Manager();
         }
         return _instance;
      }
      ...
      public function init() : void
      {
         ...
         this._currActor = new com.taomee.seer2.app.processor.activity.mascot.Mascot2Actor();
