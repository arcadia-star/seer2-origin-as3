package com.taomee.seer2.app.processor.activity.yiXingFindAndFightAct
{
   ...
   public class YiXingFindAndFightAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.yiXingFindAndFightAct.YiXingFindAndFightAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.yiXingFindAndFightAct.YiXingFindAndFightAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.yiXingFindAndFightAct.YiXingFindAndFightAct();
         }
         return _self;
      }
