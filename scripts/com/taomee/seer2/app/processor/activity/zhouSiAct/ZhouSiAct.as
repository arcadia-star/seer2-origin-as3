package com.taomee.seer2.app.processor.activity.zhouSiAct
{
   ...
   public class ZhouSiAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.zhouSiAct.ZhouSiAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.zhouSiAct.ZhouSiAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.zhouSiAct.ZhouSiAct();
         }
         return _self;
      }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("zhouSiAct/ZhouSiAct"),LoadType.SWF,function(param1:ContentInfo):void
         {
         ...
         if(parser.index == RANDOM_ID)
         {
            ...
            else if(parser.id == 4)
            {
               ...
               MovieClipUtil.playMc(sceneMC,2,sceneMC.totalFrames,function():void
               {
                  DisplayUtil.removeForParent(sceneMC);
                  sceneMC = null;
                  ModuleManager.addEventListener("MiniGameConsolePanel",ModuleEvent.DISPOSE,function(param1:ModuleEvent):void
                  {
                     _menu.visible = true;
                  });
            ...
            else if(parser.id == 6)
            {
               ...
               MovieClipUtil.playMc(sceneMC,2,sceneMC.totalFrames,function():void
               {
                  DisplayUtil.removeForParent(sceneMC);
                  sceneMC = null;
                  ModuleManager.addEventListener("ZhouSiEventFourActPanel",ModuleEvent.DISPOSE,function(param1:ModuleEvent):void
                  {
                     addRandomGift();
                  });
