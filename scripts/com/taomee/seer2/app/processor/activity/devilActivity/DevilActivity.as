package com.taomee.seer2.app.processor.activity.devilActivity
{
   ...
   public class DevilActivity
   {
      ...
      private static var _devilLoad:com.taomee.seer2.app.processor.activity.devilActivity.DevilLoad;
      ...
      private static function onSwitchComplete(param1:SceneEvent) : void
      {
         ...
         {
            _devilLoad = new com.taomee.seer2.app.processor.activity.devilActivity.DevilLoad();
