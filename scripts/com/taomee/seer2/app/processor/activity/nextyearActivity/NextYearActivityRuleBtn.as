package com.taomee.seer2.app.processor.activity.nextyearActivity
{
   ...
   public class NextYearActivityRuleBtn
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.activity.nextyearActivity.NextYearActivityRuleBtn;
      ...
      public static function get instance() : com.taomee.seer2.app.processor.activity.nextyearActivity.NextYearActivityRuleBtn
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.processor.activity.nextyearActivity.NextYearActivityRuleBtn();
         }
         return _instance;
      }
