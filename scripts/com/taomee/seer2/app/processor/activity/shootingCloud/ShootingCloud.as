package com.taomee.seer2.app.processor.activity.shootingCloud
{
   ...
   public class ShootingCloud
   {
      ...
      private var _cloudVec:Vector.<com.taomee.seer2.app.processor.activity.shootingCloud.Cloud>;
      
      private var _day:int;
      
      private var _cloud:com.taomee.seer2.app.processor.activity.shootingCloud.Cloud;
      ...
      {
         this._cloudVec = Vector.<com.taomee.seer2.app.processor.activity.shootingCloud.Cloud>([]);
         var _loc1_:int = 0;
         while(_loc1_ < 5)
         {
            this._cloudVec.push(new com.taomee.seer2.app.processor.activity.shootingCloud.Cloud(this._map.content["cloud" + _loc1_]));
      ...
      {
         var _loc1_:com.taomee.seer2.app.processor.activity.shootingCloud.Cloud = null;
      ...
      {
         var _loc2_:com.taomee.seer2.app.processor.activity.shootingCloud.Cloud = null;
      ...
      {
         var _loc4_:com.taomee.seer2.app.processor.activity.shootingCloud.Cloud = null;
