package com.taomee.seer2.app.processor.activity.cookingActivity
{
   ...
   public class CookingActivityLoad
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.activity.cookingActivity.CookingActivityLoad;
      ...
      public static function get instance() : com.taomee.seer2.app.processor.activity.cookingActivity.CookingActivityLoad
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.processor.activity.cookingActivity.CookingActivityLoad();
         }
         return _instance;
      }
