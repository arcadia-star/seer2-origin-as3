package com.taomee.seer2.app.processor.activity.waitNewYearAct
{
   ...
   public class WaitNewYearAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.waitNewYearAct.WaitNewYearAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.waitNewYearAct.WaitNewYearAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.waitNewYearAct.WaitNewYearAct();
         }
         return _self;
      }
