package com.taomee.seer2.app.processor.activity.fishingMatch
{
   ...
   public class FishingMatchManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.processor.activity.fishingMatch.FishingMatchManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.fishingMatch.FishingMatchManager
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.processor.activity.fishingMatch.FishingMatchManager();
         }
         return _instance;
      }
      ...
      {
         com.taomee.seer2.app.processor.activity.fishingMatch.FishingMatchManager.getInstance().dispose();
         com.taomee.seer2.app.processor.activity.fishingMatch.FishingMatchManager.getInstance().setup();
