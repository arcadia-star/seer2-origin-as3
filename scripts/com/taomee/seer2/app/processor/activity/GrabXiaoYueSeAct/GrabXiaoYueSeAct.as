package com.taomee.seer2.app.processor.activity.GrabXiaoYueSeAct
{
   ...
   public class GrabXiaoYueSeAct
   {
      ...
      private static var _self:com.taomee.seer2.app.processor.activity.GrabXiaoYueSeAct.GrabXiaoYueSeAct;
      ...
      public static function getInstance() : com.taomee.seer2.app.processor.activity.GrabXiaoYueSeAct.GrabXiaoYueSeAct
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.processor.activity.GrabXiaoYueSeAct.GrabXiaoYueSeAct();
         }
         return _self;
      }
