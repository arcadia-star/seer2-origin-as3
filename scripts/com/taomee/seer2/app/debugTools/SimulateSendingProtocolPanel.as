package com.taomee.seer2.app.debugTools
{
   ...
   public class SimulateSendingProtocolPanel extends Sprite
   {
      ...
      public static var _instance:com.taomee.seer2.app.debugTools.SimulateSendingProtocolPanel;
      ...
      private var _protocol:com.taomee.seer2.app.debugTools.ProtocolInfo;
      ...
      public static function instance() : com.taomee.seer2.app.debugTools.SimulateSendingProtocolPanel
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.debugTools.SimulateSendingProtocolPanel(new InterClass());
         }
         return _instance;
      }
