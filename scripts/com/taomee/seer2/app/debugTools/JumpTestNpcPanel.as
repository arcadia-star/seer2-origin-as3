package com.taomee.seer2.app.debugTools
{
   ...
   public class JumpTestNpcPanel extends Sprite
   {
      ...
      public static var _instance:com.taomee.seer2.app.debugTools.JumpTestNpcPanel;
      ...
      public static function instance() : com.taomee.seer2.app.debugTools.JumpTestNpcPanel
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.debugTools.JumpTestNpcPanel(new InterClass());
         }
         return _instance;
      }
      ...
      {
         var _loc2_:int = this._tabBtnList.indexOf(param1.currentTarget);
      ...
      {
         var _loc2_:int = this._panelItemMcList.indexOf(param1.currentTarget);
