package com.taomee.seer2.app.debugTools
{
   ...
   public class DebugTools extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.debugTools.DebugTools;
      ...
      public static function getInstance() : com.taomee.seer2.app.debugTools.DebugTools
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.debugTools.DebugTools(new InterClass());
         }
         return _instance;
      }
      ...
      {
         DisplayObjectUtil.removeFromParent(com.taomee.seer2.app.debugTools.DebugTools.getInstance());
      }
      ...
      {
         var _loc2_:int = this._funcBtnVec.indexOf(param1.currentTarget);
         if(-1 != _loc2_)
         {
