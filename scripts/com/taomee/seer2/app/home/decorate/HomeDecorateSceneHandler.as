package com.taomee.seer2.app.home.decorate
{
   ...
   public class HomeDecorateSceneHandler implements ISceneHandler
   {
      ...
      private var _decorate:com.taomee.seer2.app.home.decorate.Decorate;
      ...
      private function initDecorate(param1:ResourceLibrary) : void
      {
         ...
         {
            this._decorate = new com.taomee.seer2.app.home.decorate.Decorate(this._scene.homeInfo.decorateInfo,param1);
         }
      }
