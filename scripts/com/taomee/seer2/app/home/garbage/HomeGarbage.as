package com.taomee.seer2.app.home.garbage
{
   ...
   public class HomeGarbage extends Sprite
   {
      ...
      private var _data:com.taomee.seer2.app.home.garbage.HomeGarbageData;
      ...
      public function HomeGarbage(param1:com.taomee.seer2.app.home.garbage.HomeGarbageData, param2:ResourceLibrary)
      {
         super();
         this._data = param1;
         this._resLib = param2;
