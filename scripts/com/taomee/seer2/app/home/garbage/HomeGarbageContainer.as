package com.taomee.seer2.app.home.garbage
{
   ...
   public class HomeGarbageContainer
   {
      ...
      private var _garbageVec:Vector.<com.taomee.seer2.app.home.garbage.HomeGarbage>;
      ...
      {
         var _loc6_:com.taomee.seer2.app.home.garbage.HomeGarbage = null;
         this._garbageVec = new Vector.<com.taomee.seer2.app.home.garbage.HomeGarbage>();
         HomeGarbageHelper.prepare();
         var _loc4_:int = param1.homeInfo.garbageCount;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc6_ = new com.taomee.seer2.app.home.garbage.HomeGarbage(HomeGarbageHelper.getGarbageData(),param3);
      ...
      {
         var _loc2_:com.taomee.seer2.app.home.garbage.HomeGarbage = null;
      ...
      {
         var _loc1_:com.taomee.seer2.app.home.garbage.HomeGarbage = null;
