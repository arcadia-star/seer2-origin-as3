package com.taomee.seer2.app.home.panel.buddy
{
   ...
   public class HomeBuddyList extends Sprite
   {
      ...
      private var _buddyNumber:com.taomee.seer2.app.home.panel.buddy.HomeNumber;
      
      private var _itemVec:Vector.<com.taomee.seer2.app.home.panel.buddy.HomeBuddyItem>;
      ...
      private function createChildren() : void
      {
         ...
         this._buddyNumber = new com.taomee.seer2.app.home.panel.buddy.HomeNumber(this._container["buddyNumber"],AlignType.MIDDLE_CENTER);
      ...
      {
         var _loc2_:int = 0;
         var _loc5_:com.taomee.seer2.app.home.panel.buddy.HomeBuddyItem = null;
         this._itemVec = new Vector.<com.taomee.seer2.app.home.panel.buddy.HomeBuddyItem>();
         var _loc1_:int = -2;
         _loc2_ = 28;
         var _loc3_:int = 130;
         var _loc4_:int = 0;
         ...
         {
            (_loc5_ = new com.taomee.seer2.app.home.panel.buddy.HomeBuddyItem()).y = _loc1_;
      ...
      {
         var _loc1_:com.taomee.seer2.app.home.panel.buddy.HomeBuddyItem = null;
         this.removeToolTips();
