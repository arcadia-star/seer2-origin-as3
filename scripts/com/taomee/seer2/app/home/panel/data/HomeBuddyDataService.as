package com.taomee.seer2.app.home.panel.data
{
   ...
   public class HomeBuddyDataService extends EventDispatcher
   {
      ...
      private var _dataUnitVec:Vector.<com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit>;
      ...
      private function initDataUnitVec() : void
      {
         ...
         var _loc3_:com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit = null;
         this._dataUnitVec = new Vector.<com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit>();
         var _loc1_:Vector.<UserInfo> = UserGroupManager.getGroupAllUser(UserGroupType.BUDDY);
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = new com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit();
            _loc3_.id = _loc2_.id;
            _loc3_.userInfo = _loc2_;
            _loc3_.status = com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit.BUSY;
      ...
      {
         var _loc4_:com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit = null;
      ...
      private function addUserInfoToDataUnit() : void
      {
         ...
         var _loc2_:com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit = null;
         for each(_loc1_ in this._userInfoVec)
         {
            if(this.containsDataUnitById(_loc1_.id) == false)
            {
               _loc2_ = new com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit();
               _loc2_.id = _loc1_.id;
               _loc2_.userInfo = _loc1_;
               _loc2_.status = com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit.READY;
      ...
      public function get dataUnitVec() : Vector.<com.taomee.seer2.app.home.panel.data.HomeBuddyDataUnit>
      {
