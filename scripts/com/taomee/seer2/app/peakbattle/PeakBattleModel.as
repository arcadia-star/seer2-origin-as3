package com.taomee.seer2.app.peakbattle
{
   ...
   public class PeakBattleModel
   {
      ...
      private static var _instance:com.taomee.seer2.app.peakbattle.PeakBattleModel;
      ...
      public static function getInstance() : com.taomee.seer2.app.peakbattle.PeakBattleModel
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.peakbattle.PeakBattleModel();
         }
         return _instance;
      }
