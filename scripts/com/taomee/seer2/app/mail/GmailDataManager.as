package com.taomee.seer2.app.mail
{
   ...
   public class GmailDataManager extends EventDispatcher
   {
      ...
      private static var _instance:com.taomee.seer2.app.mail.GmailDataManager;
       
      
      private var dataList:Vector.<com.taomee.seer2.app.mail.GmailDataObj>;
      ...
      public static function getInstance() : com.taomee.seer2.app.mail.GmailDataManager
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.mail.GmailDataManager(new InterClass());
         }
         return _instance;
      }
      ...
      public function initMailData(param1:Function = null) : void
      {
         ...
         this.dataList = new Vector.<com.taomee.seer2.app.mail.GmailDataObj>();
      ...
      public function updateMailNum() : void
      {
         this.initMailData(function():void
         {
            var _loc3_:int = 0;
            var _loc1_:int = 0;
            var _loc2_:Vector.<com.taomee.seer2.app.mail.GmailDataObj> = com.taomee.seer2.app.mail.GmailDataManager.getInstance().getAllData();
      ...
      {
         var _loc5_:com.taomee.seer2.app.mail.GmailDataObj = null;
         var _loc6_:int = 0;
         ...
         while(_loc4_ < _loc3_)
         {
            (_loc5_ = new com.taomee.seer2.app.mail.GmailDataObj()).mailId = _loc2_.readUnsignedInt();
      ...
      public function saveSingleData(param1:com.taomee.seer2.app.mail.GmailDataObj) : void
      {
      ...
      public function getAllData() : Vector.<com.taomee.seer2.app.mail.GmailDataObj>
      {
         return this.dataList;
      }
      
      public function getMailDataById(param1:int) : com.taomee.seer2.app.mail.GmailDataObj
      {
         var _loc2_:int = 0;
      ...
      private function onGetMailFullData(param1:MessageEvent) : void
      {
         ...
         var _loc2_:com.taomee.seer2.app.mail.GmailDataObj = new com.taomee.seer2.app.mail.GmailDataObj();
      ...
      public function getMailByPosition(param1:int) : com.taomee.seer2.app.mail.GmailDataObj
      {
      ...
      private function sortNewToOld(param1:com.taomee.seer2.app.mail.GmailDataObj, param2:com.taomee.seer2.app.mail.GmailDataObj) : int
      {
      ...
      private function sortOldToNew(param1:com.taomee.seer2.app.mail.GmailDataObj, param2:com.taomee.seer2.app.mail.GmailDataObj) : int
      {
         if(param1.rawSendTime > param2.rawSendTime)
         {
            return 1;
