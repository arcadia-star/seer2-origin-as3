package com.taomee.seer2.app.controls
{
   ...
   public class UpContentToolbar extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.controls.UpContentToolbar;
      ...
      private var _onlineReward:com.taomee.seer2.app.controls.OnlineReward;
      ...
      public function UpContentToolbar()
      {
         ...
         this._onlineReward = new com.taomee.seer2.app.controls.OnlineReward(this._mainPanel["onlineReward"]);
      ...
      private static function get instance() : com.taomee.seer2.app.controls.UpContentToolbar
      {
         return null;
      }
