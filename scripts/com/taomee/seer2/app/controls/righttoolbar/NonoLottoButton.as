package com.taomee.seer2.app.controls.righttoolbar
{
   ...
   public class NonoLottoButton extends Sprite implements IShowable
   {
      ...
      private var _timeBehavior:com.taomee.seer2.app.controls.righttoolbar.TimerMCBehavior;
      ...
      public function NonoLottoButton()
      {
         ...
         this._timeBehavior = new com.taomee.seer2.app.controls.righttoolbar.TimerMCBehavior(UIManager.getMovieClip("UI_ToolBar_SugarTime"));
