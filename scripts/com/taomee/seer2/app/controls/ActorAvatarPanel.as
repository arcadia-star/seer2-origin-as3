package com.taomee.seer2.app.controls
{
   ...
   public class ActorAvatarPanel extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.controls.ActorAvatarPanel;
      ...
      public static function getInstance() : com.taomee.seer2.app.controls.ActorAvatarPanel
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.controls.ActorAvatarPanel();
         }
         return _instance;
      }
