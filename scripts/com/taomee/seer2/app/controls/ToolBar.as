package com.taomee.seer2.app.controls
{
   ...
   public class ToolBar extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.controls.ToolBar;
      ...
      private static function get instance() : com.taomee.seer2.app.controls.ToolBar
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.controls.ToolBar();
         }
         return _instance;
      }
      ...
      private function onSwitchComplete(param1:SceneEvent) : void
      {
         ...
         {
            com.taomee.seer2.app.controls.ToolBar.disableBtn(ShipMapWidgetClick.SHIP_MAP);
         }
         else
         {
            com.taomee.seer2.app.controls.ToolBar.enableBtn(ShipMapWidgetClick.SHIP_MAP);
         }
      }
   }
}
