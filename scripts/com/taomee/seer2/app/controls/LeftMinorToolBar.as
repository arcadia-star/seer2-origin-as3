package com.taomee.seer2.app.controls
{
   ...
   public class LeftMinorToolBar extends BlockableView
   {
      ...
      private static var _instance:com.taomee.seer2.app.controls.LeftMinorToolBar;
      ...
      private static function get instance() : com.taomee.seer2.app.controls.LeftMinorToolBar
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.controls.LeftMinorToolBar();
            _instance.x = 0;
            _instance.y = 64;
         }
         return _instance;
