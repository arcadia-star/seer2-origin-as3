package com.taomee.seer2.app.controls
{
   ...
   public class NewPlayerGuide extends Sprite
   {
      ...
      private static var _self:com.taomee.seer2.app.controls.NewPlayerGuide;
      ...
      public static function getInstance() : com.taomee.seer2.app.controls.NewPlayerGuide
      {
         if(_self == null)
         {
            _self = new com.taomee.seer2.app.controls.NewPlayerGuide();
         }
         return _self;
      }
