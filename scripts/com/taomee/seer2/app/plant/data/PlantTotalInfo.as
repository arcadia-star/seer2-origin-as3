package com.taomee.seer2.app.plant.data
{
   ...
   public class PlantTotalInfo
   {
      ...
      public var infoList:Vector.<com.taomee.seer2.app.plant.data.PlantInfo>;
      
      public function PlantTotalInfo()
      {
         this.infoList = Vector.<com.taomee.seer2.app.plant.data.PlantInfo>([]);
         super();
      }
      ...
      public function parseInfo(param1:IDataInput) : void
      {
         var _loc4_:uint = 0;
         var _loc5_:uint = 0;
         var _loc6_:com.taomee.seer2.app.plant.data.PlantInfo = null;
      ...
      {
         var _loc1_:com.taomee.seer2.app.plant.data.PlantInfo = null;
         var _loc2_:int = 0;
         while(_loc2_ < 16)
         {
            _loc1_ = new com.taomee.seer2.app.plant.data.PlantInfo();
