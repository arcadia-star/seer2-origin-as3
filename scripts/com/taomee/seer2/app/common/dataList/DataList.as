package com.taomee.seer2.app.common.dataList
{
   ...
   public class DataList extends EventDispatcher
   {
      ...
      private var _dataUnitVec:Vector.<com.taomee.seer2.app.common.dataList.DataUnit>;
      ...
      public function DataList(param1:Class, param2:Command)
      {
         ...
         this._dataUnitVec = new Vector.<com.taomee.seer2.app.common.dataList.DataUnit>();
      }
      ...
      {
         var _loc4_:int = 0;
         var _loc5_:com.taomee.seer2.app.common.dataList.DataUnit = null;
         var _loc2_:int = int(this._dataUnitVec.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      {
         var _loc6_:com.taomee.seer2.app.common.dataList.DataUnit = null;
         this.cancel();
         ...
         while(_loc5_ < _loc4_)
         {
            if(_loc5_ <= this._dataUnitVec.length - 1)
            {
               ...
               if(param3 || _loc6_ && _loc6_.status == com.taomee.seer2.app.common.dataList.DataUnit.EMPTY)
               {
                  _loc6_.status = com.taomee.seer2.app.common.dataList.DataUnit.EMPTY;
      ...
      {
         var _loc2_:com.taomee.seer2.app.common.dataList.DataUnit = null;
      ...
      {
         var _loc2_:com.taomee.seer2.app.common.dataList.DataUnit = param1.currentTarget as com.taomee.seer2.app.common.dataList.DataUnit;
      ...
      public function cancel() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(this._dataUnitVec[_loc2_].status == com.taomee.seer2.app.common.dataList.DataUnit.BUSY)
            {
      ...
      public function getDataUnit(param1:int) : com.taomee.seer2.app.common.dataList.DataUnit
      {
         var _loc2_:com.taomee.seer2.app.common.dataList.DataUnit = null;
      ...
      public function getDataUnitVec() : Vector.<com.taomee.seer2.app.common.dataList.DataUnit>
      {
         return this._dataUnitVec;
      }
      
      public function getDataOnlineUnitVec() : Vector.<com.taomee.seer2.app.common.dataList.DataUnit>
      {
         var _loc2_:com.taomee.seer2.app.common.dataList.DataUnit = null;
         var _loc1_:Vector.<com.taomee.seer2.app.common.dataList.DataUnit> = Vector.<com.taomee.seer2.app.common.dataList.DataUnit>([]);
         for each(_loc2_ in this._dataUnitVec)
         {
