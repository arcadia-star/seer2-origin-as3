package com.taomee.seer2.app.pet.data
{
   ...
   public class PetInfo
   {
      ...
      private var _petFightStarInfo:com.taomee.seer2.app.pet.data.PetFightStarInfo;
      ...
      public var itemList:Vector.<com.taomee.seer2.app.pet.data.PetItemInfo>;
      
      public function PetInfo()
      {
         this.itemList = Vector.<com.taomee.seer2.app.pet.data.PetItemInfo>([]);
         super();
      }
      ...
      public static function readStarInfo(param1:PetInfo, param2:IDataInput) : void
      {
         ...
         {
            param1._petFightStarInfo = new com.taomee.seer2.app.pet.data.PetFightStarInfo();
         }
      ...
      public function get petFightStarInfo() : com.taomee.seer2.app.pet.data.PetFightStarInfo
      {
         return this._petFightStarInfo;
      }
      
      public function set petFightStarInfo(param1:com.taomee.seer2.app.pet.data.PetFightStarInfo) : void
      {
