package com.taomee.seer2.app.pet
{
   ...
   public class MysteryYiTeNoNoManager
   {
      ...
      private static var nono:com.taomee.seer2.app.pet.MysteryNoNo;
      ...
      {
         nono = new com.taomee.seer2.app.pet.MysteryNoNo(hitNoNoLibs);
         ...
         nono.addEventListener(com.taomee.seer2.app.pet.MysteryNoNo.CLICKED_TEN_TIME,removeNoNo);
      }
      ...
      private static function removeNoNo(param1:Event) : void
      {
         if(SceneManager.active)
         {
            nono.removeEventListener(com.taomee.seer2.app.pet.MysteryNoNo.CLICKED_TEN_TIME,removeNoNo);
