package com.taomee.seer2.app.dream
{
   ...
   public class DreamMapInfo
   {
      ...
      public var itemList:Vector.<com.taomee.seer2.app.dream.DreamItem>;
      ...
      public function DreamMapInfo(param1:IDataInput)
      {
         ...
         this.itemList = Vector.<com.taomee.seer2.app.dream.DreamItem>([]);
         var _loc4_:int = 0;
         while(_loc4_ < 3)
         {
            this.itemList.push(new com.taomee.seer2.app.dream.DreamItem(param1));
            _loc4_++;
         }
      }
   }
