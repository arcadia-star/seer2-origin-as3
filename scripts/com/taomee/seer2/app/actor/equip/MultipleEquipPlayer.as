package com.taomee.seer2.app.actor.equip
{
   ...
   public class MultipleEquipPlayer extends Sprite implements IAnimation
   {
      ...
      private var _bodyEquipPlayer:com.taomee.seer2.app.actor.equip.EquipPlayer;
      
      private var _currentLabel:String;
      
      private var _playerVec:Vector.<com.taomee.seer2.app.actor.equip.EquipPlayer>;
      ...
      {
         this._playerVec = new Vector.<com.taomee.seer2.app.actor.equip.EquipPlayer>();
      ...
      {
         var _loc1_:com.taomee.seer2.app.actor.equip.EquipPlayer = null;
      ...
      {
         var _loc2_:com.taomee.seer2.app.actor.equip.EquipPlayer = new com.taomee.seer2.app.actor.equip.EquipPlayer(param1,this._actor.getInfo());
         _loc2_.play();
      ...
      {
         var _loc2_:com.taomee.seer2.app.actor.equip.EquipPlayer = this._playerMap.getValue(param1.slotIndex) as com.taomee.seer2.app.actor.equip.EquipPlayer;
      ...
      {
         this._playerVec = Vector.<com.taomee.seer2.app.actor.equip.EquipPlayer>(this._playerMap.getValues());
      }
      ...
      {
         var _loc2_:com.taomee.seer2.app.actor.equip.EquipPlayer = null;
      ...
      {
         var _loc3_:com.taomee.seer2.app.actor.equip.EquipPlayer = null;
      ...
      private function sortBySlotDepth(param1:com.taomee.seer2.app.actor.equip.EquipPlayer, param2:com.taomee.seer2.app.actor.equip.EquipPlayer) : int
      {
