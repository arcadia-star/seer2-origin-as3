package com.taomee.seer2.app.actor
{
   ...
   public class ActorManager
   {
      ...
      private static var _actor:com.taomee.seer2.app.actor.Actor;
      ...
      public static function getActor() : com.taomee.seer2.app.actor.Actor
      {
         if(_actor == null)
         {
            _actor = new com.taomee.seer2.app.actor.Actor(actorInfo);
            _actor.stand();
         }
         return _actor;
      }
      ...
      public static function getActorById(param1:int) : com.taomee.seer2.app.actor.Actor
      {
         var _loc2_:com.taomee.seer2.app.actor.Actor = null;
      ...
      public static function getActorByPos(param1:Number, param2:Number) : com.taomee.seer2.app.actor.Actor
      {
         var _loc4_:com.taomee.seer2.app.actor.Actor = null;
         var _loc3_:Vector.<com.taomee.seer2.app.actor.Actor> = Vector.<com.taomee.seer2.app.actor.Actor>(_remoteActorMap.getValues());
         _loc3_.push(_actor);
