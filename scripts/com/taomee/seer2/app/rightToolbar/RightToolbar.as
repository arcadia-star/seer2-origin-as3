package com.taomee.seer2.app.rightToolbar
{
   ...
   public class RightToolbar extends Sprite implements IToolBar
   {
      ...
      private var _rightToolBarTime:com.taomee.seer2.app.rightToolbar.RightToolBarTime;
      
      private var _rightToolBarTimeComplete:com.taomee.seer2.app.rightToolbar.RightToolBarTimeComplete;
      
      private var _isShowLift:Boolean;
      
      private var _downListBg:MovieClip;
      
      private var _downItemList:Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>;
      ...
      public function RightToolbar()
      {
         ...
         this._rightToolBarTime = new com.taomee.seer2.app.rightToolbar.RightToolBarTime();
         this._rightToolBarTimeComplete = new com.taomee.seer2.app.rightToolbar.RightToolBarTimeComplete();
         super();
      }
      ...
      private function onOver(param1:MouseEvent) : void
      {
         ...
         this._downItemList = new Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>();
      ...
      private function clearDownList() : void
      {
         ...
         if(this._downListBg)
         {
            ...
            this._downItemList = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
