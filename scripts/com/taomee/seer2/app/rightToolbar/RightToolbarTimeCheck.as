package com.taomee.seer2.app.rightToolbar
{
   ...
   public class RightToolbarTimeCheck
   {
      ...
      private static var _upSendList:Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar> = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
      
      private static var _sendList:Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar> = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
      
      private static var _LeftSendList:Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar> = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
      ...
      private static function sendClass(param1:RightToolbarInfo) : void
      {
         ...
         if(param1.classStr != "")
         {
            _loc2_ = new (_loc4_ = getDefinitionByName("com.taomee.seer2.app.rightToolbar.toolbar." + param1.classStr))() as com.taomee.seer2.app.rightToolbar.RightToolbar;
         }
         else
         {
            _loc2_ = new com.taomee.seer2.app.rightToolbar.RightToolbar();
         }
         _loc2_.init(param1);
      ...
      private static function sendLeftClass(param1:RightToolbarInfo) : void
      {
         ...
         if(param1.classStr != "")
         {
            ...
            _loc2_ = new _loc3_() as com.taomee.seer2.app.rightToolbar.RightToolbar;
         }
         else
         {
            _loc2_ = new com.taomee.seer2.app.rightToolbar.RightToolbar();
      ...
      private static function clearLeftClass() : void
      {
         ...
         _LeftSendList = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
      }
      ...
      private static function clearClass() : void
      {
         ...
         _sendList = Vector.<com.taomee.seer2.app.rightToolbar.RightToolbar>([]);
      }
   }
}
