package com.taomee.seer2.app.rightToolbar.config
{
   ...
   public class RightToolbarConfig
   {
      ...
      private static var _rightToolbarInfoVec:Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>;
      
      private static var _upToolbarInfoVec:Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>;
      
      private static var _leftToolbarInfoVec:Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>;
      ...
      {
         var _loc1_:com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo = null;
         var _loc5_:XMLList = null;
         var _loc6_:com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo = null;
         var _loc7_:XML = null;
         var _loc8_:String = null;
         var _loc9_:XML = null;
         var _loc10_:uint = 0;
         _xml = XML(new _xmlClass());
         _rightToolbarInfoVec = Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>([]);
         _upToolbarInfoVec = Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>([]);
         _leftToolbarInfoVec = Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>([]);
         ...
         {
            _loc1_ = new com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo();
            ...
            _loc1_.type = _loc8_;
            _loc1_.toolbarInfoList = Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>([]);
            _loc5_ = _loc7_.descendants("toolbar");
            for each(_loc9_ in _loc5_)
            {
               (_loc6_ = new com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo()).type = _loc8_;
      ...
      private static function updateInfo(param1:XML, param2:com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo) : void
      {
         var _loc16_:int = 0;
      ...
      public static function getInfoVec() : Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>
      {
      ...
      public static function getUpVec() : Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>
      {
      ...
      public static function getLeftVec() : Vector.<com.taomee.seer2.app.rightToolbar.config.RightToolbarInfo>
      {
