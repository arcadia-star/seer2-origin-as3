package com.taomee.seer2.app.activity.processor.salungInvade
{
   ...
   public class SalungInvadeEngine
   {
      ...
      private static var _instance:com.taomee.seer2.app.activity.processor.salungInvade.SalungInvadeEngine;
      ...
      public static function getInstance() : com.taomee.seer2.app.activity.processor.salungInvade.SalungInvadeEngine
      {
         return !!_instance ? _instance : new com.taomee.seer2.app.activity.processor.salungInvade.SalungInvadeEngine(new Singleton());
      }
