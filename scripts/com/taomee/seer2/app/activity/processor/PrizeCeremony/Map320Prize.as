package com.taomee.seer2.app.activity.processor.PrizeCeremony
{
   ...
   public class Map320Prize
   {
      ...
      public function Map320Prize()
      {
         super();
         ServerBufferManager.getServerBuffer(ServerBufferType.FIREST_LOGIN_MAP980,function(param1:ServerBuffer):void
         {
            var _loc2_:int = param1.readDataAtPostion(6);
            if(_loc2_ == 0)
            {
               initMC();
               ServerBufferManager.updateServerBuffer(ServerBufferType.FIREST_LOGIN_MAP980,6,1);
            }
         });
      }
