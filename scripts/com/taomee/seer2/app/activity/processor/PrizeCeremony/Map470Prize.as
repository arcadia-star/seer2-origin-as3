package com.taomee.seer2.app.activity.processor.PrizeCeremony
{
   ...
   public class Map470Prize
   {
      ...
      public function Map470Prize()
      {
         super();
         ServerBufferManager.getServerBuffer(ServerBufferType.FIREST_LOGIN_MAP980,function(param1:ServerBuffer):void
         {
            var _loc2_:int = param1.readDataAtPostion(7);
            if(_loc2_ == 0)
            {
               initMC();
               ServerBufferManager.updateServerBuffer(ServerBufferType.FIREST_LOGIN_MAP980,7,1);
            }
         });
      }
