package com.taomee.seer2.app.activity.data
{
   ...
   public class ActivityDefinition
   {
      ...
      private var activityCircle:com.taomee.seer2.app.activity.data.ActivityCircle;
      ...
      public function ActivityDefinition(param1:uint, param2:String, param3:int, param4:Array, param5:Array, param6:Array)
      {
         super();
         this.id = param1;
         this.activityCircle = new com.taomee.seer2.app.activity.data.ActivityCircle(param3,param4);
         if(param5)
         {
