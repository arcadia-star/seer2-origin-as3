package com.taomee.seer2.app.activity.onlineReward
{
   ...
   public class NonoNews
   {
      ...
      private var _nonoNewsInfoVec:Vector.<com.taomee.seer2.app.activity.onlineReward.NonoNewsInfo>;
      
      private var _nonoNewsInfo:com.taomee.seer2.app.activity.onlineReward.NonoNewsInfo;
      
      private var _currIndex:int;
      
      private const TOTAL_PAGE:int = 6;
      
      public function NonoNews(param1:MovieClip)
      {
         super();
         this._rewardPanel = param1;
         this._rewardPanel.mouseEnabled = false;
         this._currIndex = 0;
      ...
      private function initEvent() : void
      {
         ...
         while(_loc1_ < this.TOTAL_PAGE)
         {
            ...
            (this._rewardPanel["page_" + _loc1_] as MovieClip).addEventListener(MouseEvent.ROLL_OVER,this.onOver);
            (this._rewardPanel["page_" + _loc1_] as MovieClip).addEventListener(MouseEvent.ROLL_OUT,this.onOut);
            _loc1_++;
         }
      }
