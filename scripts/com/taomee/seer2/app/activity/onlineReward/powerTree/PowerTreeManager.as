package com.taomee.seer2.app.activity.onlineReward.powerTree
{
   ...
   public class PowerTreeManager
   {
      ...
      public static var timerDown:com.taomee.seer2.app.activity.onlineReward.powerTree.CountDownTimer;
      ...
      {
         clearInterval(timeid);
         timerDown = new com.taomee.seer2.app.activity.onlineReward.powerTree.CountDownTimer(_mc,300);
      }
         ...
         if(_loc1_ > 0)
         {
            ...
            if(_loc4_ = TimeLimitConfig.getEndDate(_loc1_))
            {
               ...
               if(!timerDown && _loc5_ > 0 && _loc5_ < 300)
               {
                  ...
                  timerDown = new com.taomee.seer2.app.activity.onlineReward.powerTree.CountDownTimer(_mc,_loc5_);
               }
               else
               {
                  _mc["TimerUI"].visible = false;
