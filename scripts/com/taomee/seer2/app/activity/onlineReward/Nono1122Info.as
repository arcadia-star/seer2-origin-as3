package com.taomee.seer2.app.activity.onlineReward
{
   public class Nono1122Info
   {
      ...
      private static var _instance:com.taomee.seer2.app.activity.onlineReward.Nono1122Info;
      ...
      public static function instance() : com.taomee.seer2.app.activity.onlineReward.Nono1122Info
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.activity.onlineReward.Nono1122Info();
         }
         return _instance;
      }
