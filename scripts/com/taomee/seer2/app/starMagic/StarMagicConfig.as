package com.taomee.seer2.app.starMagic
{
   public class StarMagicConfig
   {
      ...
      private static var _starHunInfoVec:Vector.<com.taomee.seer2.app.starMagic.StarInfo>;
      ...
      {
         var _loc1_:com.taomee.seer2.app.starMagic.StarInfo = null;
         var _loc3_:XML = null;
         ...
         _starHunInfoVec = Vector.<com.taomee.seer2.app.starMagic.StarInfo>([]);
         var _loc2_:XMLList = _xml.descendants("runes");
         for each(_loc3_ in _loc2_)
         {
            _loc1_ = new com.taomee.seer2.app.starMagic.StarInfo();
      ...
      public static function getInfoVec() : Vector.<com.taomee.seer2.app.starMagic.StarInfo>
      {
      ...
      public static function getInfo(param1:int, param2:int) : com.taomee.seer2.app.starMagic.StarInfo
      {
         if(_starHunInfoVec.length < 1)
         {
            return null;
      ...
      public static function getInfoById(param1:int) : com.taomee.seer2.app.starMagic.StarInfo
      {
         if(_starHunInfoVec.length < 1)
         {
            return null;
