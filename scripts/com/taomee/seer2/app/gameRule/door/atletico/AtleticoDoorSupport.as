package com.taomee.seer2.app.gameRule.door.atletico
{
   ...
   public class AtleticoDoorSupport extends BaseNormalDoorSupport implements IMultiSelectable
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.atletico.AtleticoDoorSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.atletico.AtleticoDoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.atletico.AtleticoDoorSupport();
         }
         return _instance;
      }
