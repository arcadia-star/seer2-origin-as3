package com.taomee.seer2.app.gameRule.door.core.vo
{
   ...
   public class DoorLevelInfomation
   {
      ...
      private var _gateInfoVec:Vector.<com.taomee.seer2.app.gameRule.door.core.vo.HomeHonorGateInfo>;
      ...
      public function getHomeHonorGateInfo(param1:int) : com.taomee.seer2.app.gameRule.door.core.vo.HomeHonorGateInfo
      {
         var _loc2_:com.taomee.seer2.app.gameRule.door.core.vo.HomeHonorGateInfo = null;
      ...
      private function parseHomeHonorData(param1:IDataInput) : void
      {
         ...
         this._gateInfoVec = new Vector.<com.taomee.seer2.app.gameRule.door.core.vo.HomeHonorGateInfo>();
         var _loc8_:int = int(param1.readUnsignedInt());
         var _loc9_:int = 0;
         while(_loc9_ < _loc8_)
         {
            this._gateInfoVec.push(new com.taomee.seer2.app.gameRule.door.core.vo.HomeHonorGateInfo(param1));
            _loc9_++;
         }
      }
   }
