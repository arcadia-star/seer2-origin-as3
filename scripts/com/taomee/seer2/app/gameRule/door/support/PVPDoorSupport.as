package com.taomee.seer2.app.gameRule.door.support
{
   ...
   public class PVPDoorSupport implements ISupportable, IDoorSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.support.PVPDoorSupport;
       
      
      protected var _supportInfo:com.taomee.seer2.app.gameRule.door.support.DoorSupportInfo;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.support.PVPDoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.support.PVPDoorSupport();
         }
         return _instance;
      }
      ...
      public function initData(param1:Object) : void
      {
         ...
         this._supportInfo = new com.taomee.seer2.app.gameRule.door.support.DoorSupportInfo(this._initData["doorRule"],this._initData["doorType"],this._initData["targetMapId"],_loc2_);
      }
      
      public function get supportInfo() : com.taomee.seer2.app.gameRule.door.support.DoorSupportInfo
      {
