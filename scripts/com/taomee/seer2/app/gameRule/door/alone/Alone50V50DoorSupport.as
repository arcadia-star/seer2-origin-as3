package com.taomee.seer2.app.gameRule.door.alone
{
   ...
   public class Alone50V50DoorSupport implements IDoorServerEquipable, IUpDoorSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.alone.Alone50V50DoorSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.alone.Alone50V50DoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.alone.Alone50V50DoorSupport();
         }
         return _instance;
      }
