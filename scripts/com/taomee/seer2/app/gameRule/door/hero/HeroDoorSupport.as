package com.taomee.seer2.app.gameRule.door.hero
{
   ...
   public class HeroDoorSupport implements IUpDoorSupport, IMultiSelectable, IDoorServerPetable
   {
      
      private static var _instance:com.taomee.seer2.app.gameRule.door.hero.HeroDoorSupport;
      ...
      public function HeroDoorSupport()
      {
         super();
         this._supportInfo = new DoorSupportInfo(DoorRule.HERO_DOOR,DoorType.Door_NORMAL,416,"HeroDoorStartPanel");
      }
      
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.hero.HeroDoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.hero.HeroDoorSupport();
         }
         return _instance;
      }
      ...
      private function reward21() : void
      {
         ...
         {
            AlertManager.showDoorResult(true,this._supportInfo.doorType,this._supportInfo.doorRule,this._serverGivePetInfo,0,this.clearServerGive);
         }
         else
         {
