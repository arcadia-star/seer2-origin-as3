package com.taomee.seer2.app.gameRule.door.trails
{
   ...
   public class Trail50V50DoorSupport extends Base50V50DoorSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.trails.Trail50V50DoorSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.trails.Trail50V50DoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.trails.Trail50V50DoorSupport(new Block());
         }
         return _instance;
      }
