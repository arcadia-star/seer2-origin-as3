package com.taomee.seer2.app.gameRule.door.warrior
{
   ...
   public class WarriorDoorSuport extends BaseNormalDoorSupport implements IMultiSelectable
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.warrior.WarriorDoorSuport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.warrior.WarriorDoorSuport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.warrior.WarriorDoorSuport(new Block());
         }
         return _instance;
      }
