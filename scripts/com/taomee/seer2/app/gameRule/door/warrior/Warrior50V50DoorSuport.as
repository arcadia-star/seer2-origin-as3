package com.taomee.seer2.app.gameRule.door.warrior
{
   ...
   public class Warrior50V50DoorSuport extends Base50V50DoorSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.warrior.Warrior50V50DoorSuport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.warrior.Warrior50V50DoorSuport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.warrior.Warrior50V50DoorSuport(new Block());
         }
         return _instance;
      }
