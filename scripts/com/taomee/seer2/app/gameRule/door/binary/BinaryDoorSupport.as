package com.taomee.seer2.app.gameRule.door.binary
{
   ...
   public class BinaryDoorSupport implements IUpDoorSupport, IMultiSelectable, IDoorServerPetable
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.door.binary.BinaryDoorSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.door.binary.BinaryDoorSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.door.binary.BinaryDoorSupport();
         }
         return _instance;
      }
