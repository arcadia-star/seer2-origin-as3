package com.taomee.seer2.app.gameRule.ring
{
   ...
   public class RingSupport implements ISupportable
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.ring.RingSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.ring.RingSupport
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.ring.RingSupport();
         }
         return _instance;
      }
