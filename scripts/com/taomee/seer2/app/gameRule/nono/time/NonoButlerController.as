package com.taomee.seer2.app.gameRule.nono.time
{
   ...
   public class NonoButlerController
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.nono.time.NonoButlerController;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.nono.time.NonoButlerController
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.gameRule.nono.time.NonoButlerController(new PrivateClass());
         }
         return _instance;
      }
