package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptKadoshSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptKadoshSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptKadoshSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptKadoshSupport(new Singleton());
         }
         return _instance;
      }
