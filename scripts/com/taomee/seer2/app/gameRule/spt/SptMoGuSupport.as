package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptMoGuSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptMoGuSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptMoGuSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptMoGuSupport();
         }
         return _instance;
      }
      ...
      {
         _sptBossId = SPTBossID.MoGu;
         _petMaxLevelLimit = SptConfigInfoManager.getSptBossLevel(_sptBossId);
         _sptBufferPosition = SPTBufferStatus.MOGU_POSITION;
         super.init(param1);
      }
      ...
      private function checkServerBufferHandler(param1:ServerBuffer) : void
      {
         ...
         {
            var _loc2_:uint = SptBossInfoManager.resolveSpt(SPTBossID.MMdi,param1);
