package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptMMdiSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptMMdiSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptMMdiSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptMMdiSupport(new Block());
         }
         return _instance;
      }
