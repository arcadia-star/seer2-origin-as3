package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptSaLaiErSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptSaLaiErSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptSaLaiErSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptSaLaiErSupport();
         }
         return _instance;
      }
      ...
      {
         _sptBossId = SPTBossID.SaLaiEr;
         _petMaxLevelLimit = SptConfigInfoManager.getSptBossLevel(_sptBossId);
         _sptBufferPosition = SPTBufferStatus.SALAIER_POSETION;
         super.init(param1);
      }
