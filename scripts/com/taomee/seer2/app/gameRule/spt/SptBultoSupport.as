package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptBultoSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptBultoSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptBultoSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptBultoSupport(new Block());
         }
         return _instance;
      }
