package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptAilixisiSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptAilixisiSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptAilixisiSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptAilixisiSupport(new Block());
         }
         return _instance;
      }
