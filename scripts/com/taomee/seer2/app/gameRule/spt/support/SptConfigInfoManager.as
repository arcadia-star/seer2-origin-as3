package com.taomee.seer2.app.gameRule.spt.support
{
   public class SptConfigInfoManager
   {
      ...
      public static var bossInfoVec:Vector.<com.taomee.seer2.app.gameRule.spt.support.SptBossInfo>;
      ...
      {
         var _loc2_:XML = null;
         var _loc3_:com.taomee.seer2.app.gameRule.spt.support.SptBossInfo = null;
         bossInfoVec = new Vector.<com.taomee.seer2.app.gameRule.spt.support.SptBossInfo>();
         _xml = XML(new _xmlClass());
         var _loc1_:XMLList = _xml.descendants("Boss");
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = new com.taomee.seer2.app.gameRule.spt.support.SptBossInfo();
