package com.taomee.seer2.app.gameRule.spt.support
{
   public class SptDialogConfig
   {
      ...
      public static var infoVec:Vector.<com.taomee.seer2.app.gameRule.spt.support.SptDialogInfo>;
      ...
      {
         var _loc2_:XML = null;
         var _loc3_:com.taomee.seer2.app.gameRule.spt.support.SptDialogInfo = null;
         infoVec = new Vector.<com.taomee.seer2.app.gameRule.spt.support.SptDialogInfo>();
         _xml = XML(new _xmlClass());
         var _loc1_:XMLList = _xml.descendants("spt");
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = new com.taomee.seer2.app.gameRule.spt.support.SptDialogInfo();
