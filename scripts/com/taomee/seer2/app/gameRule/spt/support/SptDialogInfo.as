package com.taomee.seer2.app.gameRule.spt.support
{
   public class SptDialogInfo
   {
      ...
      public var content:Vector.<com.taomee.seer2.app.gameRule.spt.support.SptDialogContentInfo>;
      ...
      public function SptDialogInfo()
      {
         ...
         this.content = new Vector.<com.taomee.seer2.app.gameRule.spt.support.SptDialogContentInfo>();
      }
      ...
      {
         var _loc5_:com.taomee.seer2.app.gameRule.spt.support.SptDialogContentInfo = null;
         var _loc2_:XMLList = param1["sptDialog"];
         var _loc3_:uint = uint(_loc2_.length());
         var _loc4_:uint = 0;
         while(_loc4_ < _loc3_)
         {
            (_loc5_ = new com.taomee.seer2.app.gameRule.spt.support.SptDialogContentInfo()).id = uint(XML(_loc2_[_loc4_]).attribute("id"));
