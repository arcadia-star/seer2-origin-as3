package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptHuoKeSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptHuoKeSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptHuoKeSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptHuoKeSupport(new Block());
         }
         return _instance;
      }
