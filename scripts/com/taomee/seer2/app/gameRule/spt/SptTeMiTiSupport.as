package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptTeMiTiSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptTeMiTiSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptTeMiTiSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptTeMiTiSupport();
         }
         return _instance;
      }
