package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptAKanasiSupport extends BaseSptSupport
   {
      ...
      private static var _instance:com.taomee.seer2.app.gameRule.spt.SptAKanasiSupport;
      ...
      public static function getInstance() : com.taomee.seer2.app.gameRule.spt.SptAKanasiSupport
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.gameRule.spt.SptAKanasiSupport(new Block());
         }
         return _instance;
      }
