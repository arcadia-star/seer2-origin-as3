package com.taomee.seer2.app.copySystem
{
   ...
   public class CopyManager
   {
      ...
      private static var _self:com.taomee.seer2.app.copySystem.CopyManager;
      ...
      public static function instance() : com.taomee.seer2.app.copySystem.CopyManager
      {
         if(null == _self)
         {
            _self = new com.taomee.seer2.app.copySystem.CopyManager();
         }
         return _self;
      }
