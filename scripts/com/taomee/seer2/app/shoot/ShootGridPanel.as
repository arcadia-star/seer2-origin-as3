package com.taomee.seer2.app.shoot
{
   ...
   public class ShootGridPanel extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.app.shoot.ShootGridPanel;
      ...
      private var _itemVec:Vector.<com.taomee.seer2.app.shoot.ShootGridItem>;
      
      public function ShootGridPanel()
      {
         var _loc5_:com.taomee.seer2.app.shoot.ShootGridItem = null;
         super();
         mouseEnabled = false;
         ...
         addChild(this._bg);
         this._itemVec = new Vector.<com.taomee.seer2.app.shoot.ShootGridItem>();
         ...
         while(_loc4_ < _loc2_)
         {
            if(_loc1_[_loc4_] != 0)
            {
               (_loc5_ = new com.taomee.seer2.app.shoot.ShootGridItem()).x = 6 + (_loc5_.width + 4) * _loc3_;
               _loc5_.y = 6;
      ...
      public static function get instance() : com.taomee.seer2.app.shoot.ShootGridPanel
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.shoot.ShootGridPanel();
         }
         return _instance;
      }
      ...
      {
         var _loc2_:com.taomee.seer2.app.shoot.ShootGridItem = param1.currentTarget as com.taomee.seer2.app.shoot.ShootGridItem;
         if(_loc2_.id > 0)
         {
            if(_loc2_.canShoot)
            {
