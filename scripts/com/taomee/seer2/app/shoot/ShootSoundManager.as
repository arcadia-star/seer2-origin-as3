package com.taomee.seer2.app.shoot
{
   ...
   public class ShootSoundManager
   {
      ...
      private static var instance:com.taomee.seer2.app.shoot.ShootSoundManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.shoot.ShootSoundManager
      {
         if(instance == null)
         {
            instance = new com.taomee.seer2.app.shoot.ShootSoundManager(new PrivateClass());
         }
         return instance;
      }
