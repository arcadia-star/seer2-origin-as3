package com.taomee.seer2.app.manager
{
   ...
   public class MapMailManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.manager.MapMailManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.manager.MapMailManager
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.manager.MapMailManager(new PrivateClass());
         }
         return _instance;
      }
