package com.taomee.seer2.app.manager
{
   ...
   public class MiuSiWakeupFirstManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.manager.MiuSiWakeupFirstManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.manager.MiuSiWakeupFirstManager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.manager.MiuSiWakeupFirstManager();
         }
         return _instance;
      }
