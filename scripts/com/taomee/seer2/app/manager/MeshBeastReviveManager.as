package com.taomee.seer2.app.manager
{
   ...
   public class MeshBeastReviveManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.manager.MeshBeastReviveManager;
      ...
      public static function get instance() : com.taomee.seer2.app.manager.MeshBeastReviveManager
      {
         if(!_instance)
         {
            _instance = new com.taomee.seer2.app.manager.MeshBeastReviveManager();
         }
         return _instance;
      }
      ...
      private function initMap100() : void
      {
         ...
         var _loc1_:XML = <npc id="406" resId="406" name="目灵兽" dir="0" width="166" height="203" pos="475,320" actorPos="700,310" path=""/>;
