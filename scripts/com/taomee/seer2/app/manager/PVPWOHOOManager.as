package com.taomee.seer2.app.manager
{
   ...
   public class PVPWOHOOManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.manager.PVPWOHOOManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.manager.PVPWOHOOManager
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.manager.PVPWOHOOManager(new PrivateClass());
         }
         return _instance;
      }
