package com.taomee.seer2.app.manager
{
   ...
   public class LocalMsgManager
   {
      ...
      private static var _instance:com.taomee.seer2.app.manager.LocalMsgManager;
      ...
      public static function getInstance() : com.taomee.seer2.app.manager.LocalMsgManager
      {
         if(_instance == null)
         {
            _instance = new com.taomee.seer2.app.manager.LocalMsgManager(new PrivateClass());
         }
         return _instance;
      }
