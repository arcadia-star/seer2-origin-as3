package com.taomee.seer2.app.plantSystem
{
   ...
   public class PlantManager
   {
      ...
      private var _landList:Vector.<com.taomee.seer2.app.plantSystem.PlantLand>;
      ...
      private var _plantSetInfo:com.taomee.seer2.app.plantSystem.PlantSetInfo;
      ...
      {
         this._landList = Vector.<com.taomee.seer2.app.plantSystem.PlantLand>([]);
         this._scene = SceneManager.active as PlantScene;
         var _loc1_:int = 0;
         while(_loc1_ < 16)
         {
            this._landList.push(new com.taomee.seer2.app.plantSystem.PlantLand(SceneManager.active.mapModel.content["land" + _loc1_],this._scene.plantInfo.infoList[_loc1_],this._load));
            _loc1_++;
         }
         var _loc2_:int = 0;
         while(_loc2_ < 4)
      ...
      {
         var _loc2_:com.taomee.seer2.app.plantSystem.PlantLand = null;
      ...
      private function onPlantSetInfo(param1:MessageEvent) : void
      {
         ...
         var _loc2_:IDataInput = param1.message.getRawData();
         this._plantSetInfo = new com.taomee.seer2.app.plantSystem.PlantSetInfo(_loc2_);
      ...
      {
         var _loc1_:com.taomee.seer2.app.plantSystem.PlantLand = null;
         if(this._load)
         {
            this._load.dispose();
         }
