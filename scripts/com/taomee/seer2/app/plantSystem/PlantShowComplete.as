package com.taomee.seer2.app.plantSystem
{
   ...
   public class PlantShowComplete
   {
      ...
      private var _completeList:Vector.<com.taomee.seer2.app.plantSystem.PlantCompleteItem>;
      ...
      {
         this._completeList = Vector.<com.taomee.seer2.app.plantSystem.PlantCompleteItem>([]);
         this._index = 0;
         this.playMove();
      }
      ...
      {
         var plantComplete:com.taomee.seer2.app.plantSystem.PlantCompleteItem = null;
         if(this._index < this._idList.length)
         {
            plantComplete = new com.taomee.seer2.app.plantSystem.PlantCompleteItem(this._idList[this._index],this._countList[this._index]);
      ...
      {
         var _loc1_:com.taomee.seer2.app.plantSystem.PlantCompleteItem = null;
