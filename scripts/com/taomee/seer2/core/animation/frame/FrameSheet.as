package com.taomee.seer2.core.animation.frame
{
   ...
   public class FrameSheet
   {
      ...
      private var _frameInfoVec:Vector.<com.taomee.seer2.core.animation.frame.FrameInfo>;
      ...
      {
         var _loc5_:com.taomee.seer2.core.animation.frame.FrameInfo = null;
         ...
         this._frameInfoVec = new Vector.<com.taomee.seer2.core.animation.frame.FrameInfo>();
         var _loc4_:int = 0;
         while(_loc4_ < this._frameNum)
         {
            (_loc5_ = new com.taomee.seer2.core.animation.frame.FrameInfo()).keyNum = _loc2_.readShort();
      ...
      public function getFrameInfo(param1:int) : com.taomee.seer2.core.animation.frame.FrameInfo
      {
         var _loc2_:uint = this.findFrameInfoIndex(param1);
         var _loc3_:com.taomee.seer2.core.animation.frame.FrameInfo = this._frameInfoVec[_loc2_];
      ...
      {
         var _loc4_:com.taomee.seer2.core.animation.frame.FrameInfo = null;
      ...
      private function createFrameData(param1:com.taomee.seer2.core.animation.frame.FrameInfo, param2:int) : void
      {
      ...
      {
         var _loc1_:com.taomee.seer2.core.animation.frame.FrameInfo = null;
         this.removeImageLoaderEventListener();
