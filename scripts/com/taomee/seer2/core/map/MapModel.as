package com.taomee.seer2.core.map
{
   ...
   public class MapModel extends EventDispatcher implements IMapModel
   {
      ...
      protected var _libManager:com.taomee.seer2.core.map.ResourceLibrary;
      
      protected var _assetExtractor:MapAssetExtractor;
      
      protected var _mapProcessor:com.taomee.seer2.core.map.MapProcessor;
      ...
      {
         this._mapProcessor = com.taomee.seer2.core.map.MapProcessor.createMapProcessor(this);
      ...
      public function get libManager() : com.taomee.seer2.core.map.ResourceLibrary
      {
         return this._libManager;
      }
      
      public function get mapProcessor() : com.taomee.seer2.core.map.MapProcessor
      {
