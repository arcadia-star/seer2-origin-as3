package com.taomee.seer2.core.map.grids
{
   ...
   public class RoadPointLayer extends BaseDisplayObject
   {
      ...
      private var _childMap:com.taomee.seer2.core.map.grids.HashMap;
      
      private var _map:com.taomee.seer2.core.map.grids.GameMap;
      
      public function RoadPointLayer(param1:com.taomee.seer2.core.map.grids.GameMap)
      {
         super();
         this._map = param1;
         this._cellWidth = param1.cellWidth;
         this._cellHeight = param1.cellHeight;
         this._childMap = new com.taomee.seer2.core.map.grids.HashMap();
      }
