package com.taomee.seer2.core.map.grids
{
   ...
   public class GameMap extends BaseDisplayObject
   {
      ...
      private var _player:com.taomee.seer2.core.map.grids.HeptaFishCharacter;
      ...
      private var _mapLayer:com.taomee.seer2.core.map.grids.MapLayer;
      
      private var _buildLayer:com.taomee.seer2.core.map.grids.BuildingLayer;
      
      private var _gridLayer:com.taomee.seer2.core.map.grids.GridLayer;
      
      private var _roadPointLayer:com.taomee.seer2.core.map.grids.RoadPointLayer;
      
      private var _initPlayerPoint:Point;
      
      private var _roadSeeker:com.taomee.seer2.core.map.grids.RoadSeeker;
      
      private var _roadArr:Array;
      
      private var _roadMap:com.taomee.seer2.core.map.grids.HashMap;
      ...
      public function GameMap(param1:BaseMapLoader, param2:Point = null)
      {
         ...
         this._roadMap = new com.taomee.seer2.core.map.grids.HashMap();
         super();
         ...
         this._roadSeeker = new com.taomee.seer2.core.map.grids.RoadSeeker(this._mapDArr,this._cellWidth,this._cellHeight * 2);
      }
      
      public function initMap() : void
      {
         this._mapLayer = new com.taomee.seer2.core.map.grids.MapLayer(this);
         this._buildLayer = new com.taomee.seer2.core.map.grids.BuildingLayer(this);
      ...
      public function addPlayer(param1:com.taomee.seer2.core.map.grids.HeptaFishCharacter) : void
      {
      ...
      public function get mapLayer() : com.taomee.seer2.core.map.grids.MapLayer
      {
      ...
      public function get buildLayer() : com.taomee.seer2.core.map.grids.BuildingLayer
      {
