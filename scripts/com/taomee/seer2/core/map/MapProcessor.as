package com.taomee.seer2.core.map
{
   ...
   public class MapProcessor
   {
      ...
      protected var _map:com.taomee.seer2.core.map.MapModel;
      
      public function MapProcessor(param1:com.taomee.seer2.core.map.MapModel)
      {
         super();
         this._map = param1;
      }
      
      public static function createMapProcessor(param1:com.taomee.seer2.core.map.MapModel) : MapProcessor
      {
