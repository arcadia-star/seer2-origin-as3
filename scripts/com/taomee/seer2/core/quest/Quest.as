package com.taomee.seer2.core.quest
{
   ...
   public class Quest
   {
      ...
      private var _prerequisite:com.taomee.seer2.core.quest.QuestPrerequisite;
      
      private var _acceptDialog:DialogDefinition;
      
      public var acceptNpcId:int;
      
      private var _stepVec:Vector.<com.taomee.seer2.core.quest.QuestStep>;
      ...
      public function parseDefinition(param1:QuestDefinition) : void
      {
         ...
         this._prerequisite = new com.taomee.seer2.core.quest.QuestPrerequisite(param1.prerequisiteDefinition);
         ...
         this._stepVec = new Vector.<com.taomee.seer2.core.quest.QuestStep>();
         for each(_loc2_ in param1.stepDefinitionVec)
         {
            this._stepVec.push(new com.taomee.seer2.core.quest.QuestStep(this,_loc2_));
         }
      ...
      {
         var _loc2_:com.taomee.seer2.core.quest.QuestStep = null;
      ...
      public function getCurrentStepVec() : Vector.<com.taomee.seer2.core.quest.QuestStep>
      {
         var _loc2_:com.taomee.seer2.core.quest.QuestStep = null;
         var _loc1_:Vector.<com.taomee.seer2.core.quest.QuestStep> = new Vector.<com.taomee.seer2.core.quest.QuestStep>();
      ...
      public function getCurrentOrNextStep() : com.taomee.seer2.core.quest.QuestStep
      {
         var _loc1_:int = 1;
      ...
      public function getStep(param1:int) : com.taomee.seer2.core.quest.QuestStep
      {
         return this._stepVec[param1 - 1];
      }
      
      public function getStepVec() : Vector.<com.taomee.seer2.core.quest.QuestStep>
      {
