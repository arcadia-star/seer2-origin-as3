package com.taomee.seer2.core.entity
{
   ...
   public class AnimateElementManager
   {
      ...
      private static var _animationVec:Vector.<com.taomee.seer2.core.entity.AnimateElement>;
      ...
      {
         _scene = param1;
         _animationVec = new Vector.<com.taomee.seer2.core.entity.AnimateElement>();
      }
      ...
      public static function createElement(param1:ResourceLibrary, param2:AnimationDefinition) : void
      {
         ...
         var _loc6_:com.taomee.seer2.core.entity.AnimateElement = null;
         ...
         if(_loc3_ != null)
         {
            ...
            (_loc6_ = new com.taomee.seer2.core.entity.AnimateElement()).animation = _loc5_;
            _loc6_.x = param2.x;
            _loc6_.y = param2.y;
      ...
      private static function processEventHandler(param1:com.taomee.seer2.core.entity.AnimateElement, param2:AnimationDefinition) : void
      {
      ...
      public static function addElement(param1:com.taomee.seer2.core.entity.AnimateElement) : void
      {
         _scene.mapModel.content.addChild(param1);
         addToAnimationVec(param1);
      }
      
      public static function getElement(param1:uint) : com.taomee.seer2.core.entity.AnimateElement
      {
         var _loc2_:com.taomee.seer2.core.entity.AnimateElement = null;
      ...
      private static function addToAnimationVec(param1:com.taomee.seer2.core.entity.AnimateElement) : void
      {
         var _loc2_:com.taomee.seer2.core.entity.AnimateElement = null;
         for each(_loc2_ in _animationVec)
         {
      ...
      {
         var _loc1_:com.taomee.seer2.core.entity.AnimateElement = null;
