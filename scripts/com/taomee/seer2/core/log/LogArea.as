package com.taomee.seer2.core.log
{
   ...
   public class LogArea extends Sprite
   {
      ...
      private static var _logArea:com.taomee.seer2.core.log.LogArea;
      ...
      public static function getInstance() : com.taomee.seer2.core.log.LogArea
      {
         if(_logArea == null)
         {
            _logArea = new com.taomee.seer2.core.log.LogArea(new InterClass());
         }
         return _logArea;
      }
      ...
      {
         DisplayObjectUtil.removeFromParent(com.taomee.seer2.core.log.LogArea.getInstance());
      }
