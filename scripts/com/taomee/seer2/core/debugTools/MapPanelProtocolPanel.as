package com.taomee.seer2.core.debugTools
{
   ...
   public class MapPanelProtocolPanel extends Sprite
   {
      ...
      private static var _instance:com.taomee.seer2.core.debugTools.MapPanelProtocolPanel;
      ...
      public static function instance() : com.taomee.seer2.core.debugTools.MapPanelProtocolPanel
      {
         var _loc1_:com.taomee.seer2.core.debugTools.MapPanelProtocolPanel = null;
         if(_instance == null)
         {
            _loc1_ = new com.taomee.seer2.core.debugTools.MapPanelProtocolPanel(new InterClass());
      ...
      {
         var _loc2_:int = this._checkBoxList.indexOf(param1.currentTarget);
         if(-1 != _loc2_)
         {
