package mx.rpc.xml
{
   ...
   public class SimpleXMLEncoder
   {
      ...
      public function encodeValue(param1:Object, param2:QName, param3:XMLNode) : XMLNode
      {
         ...
         var _loc5_:uint;
         if((_loc5_ = this.getDataTypeFromObject(param1)) == SimpleXMLEncoder.FUNCTION_TYPE)
         {
            return null;
         }
         ...
         (_loc4_ = this.myXMLDoc.createElement("foo")).nodeName = param2.localName;
         param3.appendChild(_loc4_);
         ...
         else
         {
            ...
            else if(_loc5_ == SimpleXMLEncoder.NUMBER_TYPE)
            {
               ...
               else if((_loc18_ = (_loc17_ = String(param1.toString())).substr(0,2)) == "0X" || _loc18_ == "0x")
               {
            ...
            {
               _loc15_ = String(param1.toString());
            }
