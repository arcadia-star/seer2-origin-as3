package mx.effects
{
   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      mx_internal var parentCompositeEffect:mx.effects.Effect;
         ...
         if(!this.customFilter)
         {
            ...
            switch(param1)
            {
               ...
               case "show":
                  ...
                  break;
               case "move":
                  this.mx_internal::filterObject = new mx.effects.EffectTargetFilter();
      ...
      public function stop() : void
      {
         ...
         var _loc1_:int = int(this._instances.length - 1);
