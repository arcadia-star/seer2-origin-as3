package mx.core
{
   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      private var _designLayer:mx.core.DesignLayer;
      ...
      override public function set x(param1:Number) : void
      {
         ...
         if(Boolean(this.parent) && this.parent is mx.core.UIComponent)
         {
      ...
      public function set designLayer(param1:mx.core.DesignLayer) : void
      {
      ...
      protected function invalidateSystemManager() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if(_loc4_ = _loc1_.getChildAt(_loc3_) as mx.core.UIComponent)
            {
      ...
      protected function commitProperties() : void
      {
         ...
         if(FlexVersion.compatibilityVersion >= FlexVersion.VERSION_4_0)
         {
            _loc4_ = this.parent as mx.core.UIComponent;
      ...
      public function addStyleClient(param1:IAdvancedStyleClient) : void
      {
         ...
         if(!(param1 is DisplayObject))
         {
            ...
            {
               _loc2_ = param1.styleParent as mx.core.UIComponent;
               if(_loc2_)
               {
      ...
      mx_internal function initThemeColor() : Boolean
      {
         ...
         if(this.styleManager.hasAdvancedSelectors())
         {
            ...
            {
               _loc5_ = int((_loc6_ = StyleProtoChain.getMatchingStyleDeclarations(this)).length - 1);
               while(_loc5_ >= 0)
               {
      ...
      public function determineTextFormatFromStyles() : mx.core.UITextFormat
      {
         ...
         var _loc3_:String = null;
         var _loc1_:mx.core.UITextFormat = this.cachedTextFormat;
         if(!_loc1_)
         {
            _loc2_ = StringUtil.trimArrayElements(this._inheritingStyles.fontFamily,",");
            _loc1_ = new mx.core.UITextFormat(this.mx_internal::getNonNullSystemManager(),_loc2_);
      ...
      mx_internal function getFontContext(param1:String, param2:Boolean, param3:Boolean, param4:* = undefined) : mx.core.IFlexModuleFactory
      {
         if(noEmbeddedFonts)
         {
            return null;
         }
         var _loc5_:mx.core.IEmbeddedFontRegistry;
      ...
      protected function createInFontContext(param1:Class) : Object
      {
         ...
         var _loc8_:mx.core.IFlexModuleFactory = !!this.oldEmbeddedFontContext ? this.oldEmbeddedFontContext : this.moduleFactory;
         var _loc9_:Object;
      ...
      public function hasFontContextChanged() : Boolean
      {
         ...
         var _loc6_:mx.core.IFlexModuleFactory;
      ...
      private function internal_initAdvancedLayoutFeatures() : mx.core.AdvancedLayoutFeatures
      {
         var _loc1_:mx.core.AdvancedLayoutFeatures = new mx.core.AdvancedLayoutFeatures();
         this._hasComplexLayoutMatrix = true;
