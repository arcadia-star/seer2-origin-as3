package mx.core
{
   ...
   public class DesignLayer extends EventDispatcher implements IMXMLObject
   {
      ...
      private var _parent:mx.core.DesignLayer;
      ...
      protected function parentChanged(param1:mx.core.DesignLayer) : void
      {
      ...
      public function get effectiveVisibility() : Boolean
      {
         ...
         var _loc2_:mx.core.DesignLayer = this;
      ...
      {
         var _loc3_:mx.core.DesignLayer = null;
      ...
      public function addLayer(param1:mx.core.DesignLayer) : void
      {
         param1.parentChanged(this);
         this.layerChildren.push(param1);
      }
      
      public function getLayerAt(param1:int) : mx.core.DesignLayer
      {
      ...
      public function removeLayer(param1:mx.core.DesignLayer) : void
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.layerChildren.length)
         {
