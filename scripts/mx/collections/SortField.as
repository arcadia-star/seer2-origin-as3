package mx.collections
{
   ...
   public class SortField extends EventDispatcher implements ISortField
   {
      ...
      private function nullCompare(param1:Object, param2:Object) : int
      {
         ...
         _loc9_ = String(this.resourceManager.getString("collections","noComparatorSortField",[this.name]));
      ...
      private function xmlCompare(param1:Object, param2:Object) : int
      {
         ...
         try
         {
            _loc3_ = this._name == null ? String(param1.toString()) : String(param1[this._name].toString());
         }
         catch(error:Error)
         {
         }
         try
         {
            _loc4_ = this._name == null ? String(param2.toString()) : String(param2[this._name].toString());
         }
         catch(error:Error)
         {
         }
