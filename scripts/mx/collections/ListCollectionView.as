package mx.collections
{
   ...
   public class ListCollectionView extends Proxy implements ICollectionView, mx.collections.IList, IMXMLObject
   {
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") var dispatchResetEvent:Boolean = true;
      ...
      private var _sort:mx.collections.ISort;
      ...
      public function get sort() : mx.collections.ISort
      {
         return this._sort;
      }
      
      public function set sort(param1:mx.collections.ISort) : void
      {
         this._sort = param1;
      ...
      public function getItemAt(param1:int, param2:int = 0) : Object
      {
         ...
         {
            _loc3_ = String(this.resourceManager.getString("collections","outOfBounds",[param1]));
      ...
      public function setItemAt(param1:Object, param2:int) : Object
      {
         ...
         {
            _loc4_ = String(this.resourceManager.getString("collections","outOfBounds",[param2]));
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") function getLocalItemIndex(param1:Object) : int
      {
         var _loc2_:int = 0;
      ...
      override flash_proxy function getProperty(param1:*) : *
      {
         ...
         if(_loc2_ == -1)
         {
            _loc4_ = String(this.resourceManager.getString("collections","unknownProperty",[param1]));
      ...
      override flash_proxy function setProperty(param1:*, param2:*) : void
      {
         ...
         if(_loc3_ == -1)
         {
            _loc5_ = String(this.resourceManager.getString("collections","unknownProperty",[param1]));
         ...
         if(this.localIndex)
         {
            ...
            while(_loc8_ < param1.length)
            {
               ...
               if(this.filterFunction == null || this.filterFunction(_loc9_))
               {
                  ...
                  {
                     _loc10_ = String(this.resourceManager.getString("collections","incorrectAddition"));
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") function findItem(param1:Object, param2:String, param3:Boolean = false) : int
      {
         var _loc4_:String = null;
         if(!this.sort || !this.localIndex)
         {
            _loc4_ = String(this.resourceManager.getString("collections","itemNotFound"));
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") function getBookmark(param1:int) : ListCollectionViewBookmark
      {
         ...
         {
            message = String(this.resourceManager.getString("collections","invalidIndex",[index]));
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") function getBookmarkIndex(param1:CursorBookmark) : int
      {
         ...
         {
            message = String(this.resourceManager.getString("collections","bookmarkNotFound"));
            throw new CollectionViewError(message);
         }
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") function reset() : void
      {
...
class ListCollectionViewCursor extends EventDispatcher implements IViewCursor
{
   ...
   public function insert(param1:Object) : void
   {
      ...
      else if(this.beforeFirst)
      {
         ...
         {
            _loc3_ = String(this.resourceManager.getString("collections","invalidInsert"));
   ...
   public function remove() : Object
   {
      ...
      {
         message = String(this.resourceManager.getString("collections","invalidRemove"));
   ...
   public function seek(param1:CursorBookmark, param2:int = 0, param3:int = 0) : void
   {
      ...
      else if(bookmark != CursorBookmark.CURRENT)
      {
         try
         {
            ...
            {
               this.setCurrent(null);
               message = String(this.resourceManager.getString("collections","bookmarkInvalid"));
               throw new CursorError(message);
            }
         }
   ...
   private function checkValid() : void
   {
      ...
      if(this.invalid)
      {
         _loc1_ = String(this.resourceManager.getString("collections","invalidCursor"));
...
class ListCollectionViewBookmark extends CursorBookmark
{
   ...
   §§namespace("http://www.adobe.com/2006/flex/mx/internal") var index:int;
   
   §§namespace("http://www.adobe.com/2006/flex/mx/internal") var view:ListCollectionView;
   
   §§namespace("http://www.adobe.com/2006/flex/mx/internal") var viewRevision:int;
