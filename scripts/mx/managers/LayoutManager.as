package mx.managers
{
   ...
   public class LayoutManager extends EventDispatcher implements ILayoutManager
   {
      ...
      private var systemManager:mx.managers.ISystemManager;
      
      private var currentObject:mx.managers.ILayoutManagerClient;
      ...
      public function invalidateProperties(param1:mx.managers.ILayoutManagerClient) : void
      {
      ...
      public function invalidateSize(param1:mx.managers.ILayoutManagerClient) : void
      {
      ...
      public function invalidateDisplayList(param1:mx.managers.ILayoutManagerClient) : void
      {
      ...
      {
         var _loc1_:mx.managers.ILayoutManagerClient = ILayoutManagerClient(this.invalidatePropertiesQueue.removeSmallest());
         while(_loc1_)
         {
            if(_loc1_.nestLevel)
            {
      ...
      {
         var _loc1_:mx.managers.ILayoutManagerClient = ILayoutManagerClient(this.invalidateSizeQueue.removeLargest());
         while(_loc1_)
         {
            if(_loc1_.nestLevel)
            {
      ...
      {
         var _loc1_:mx.managers.ILayoutManagerClient = ILayoutManagerClient(this.invalidateDisplayListQueue.removeSmallest());
         while(_loc1_)
         {
            if(_loc1_.nestLevel)
            {
      ...
      {
         var _loc1_:mx.managers.ILayoutManagerClient = null;
      ...
      public function validateClient(param1:mx.managers.ILayoutManagerClient, param2:Boolean = false) : void
      {
         var _loc4_:mx.managers.ILayoutManagerClient = null;
         var _loc3_:mx.managers.ILayoutManagerClient = this.currentObject;
         var _loc5_:int = 0;
      ...
      public function attachListeners(param1:mx.managers.ISystemManager) : void
      {
      ...
      private function usingBridge(param1:mx.managers.ISystemManager) : Boolean
      {
