package mx.managers
{
   ...
   public class CursorManagerImpl extends EventDispatcher implements mx.managers.ICursorManager
   {
      ...
      mx_internal var systemManager:mx.managers.ISystemManager = null;
      ...
      public function CursorManagerImpl(param1:mx.managers.ISystemManager = null)
      {
         ...
         if(param1)
         {
            this.mx_internal::systemManager = param1 as mx.managers.ISystemManager;
         }
         else
         {
            this.mx_internal::systemManager = SystemManagerGlobals.topLevelSystemManagers[0] as mx.managers.ISystemManager;
         }
         if(mixins)
         {
