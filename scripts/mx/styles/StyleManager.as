package mx.styles
{
   ...
   public class StyleManager
   {
      ...
      public static function getStyleManager(param1:IFlexModuleFactory) : mx.styles.IStyleManager2
      {
         var _loc2_:mx.styles.IStyleManager2 = null;
         ...
         else
         {
            ...
            {
               _loc2_ = _loc4_ as mx.styles.IStyleManager2;
            }
         }
         return _loc2_;
      }
