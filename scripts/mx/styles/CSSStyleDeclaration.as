package mx.styles
{
   ...
   public class CSSStyleDeclaration extends EventDispatcher
   {
      ...
      private var _selector:mx.styles.CSSSelector;
      
      private var _selectorString:String;
      
      public function CSSStyleDeclaration(param1:Object = null, param2:mx.styles.IStyleManager2 = null, param3:Boolean = true)
      {
         this.clones = new Dictionary(true);
         super();
         if(!param2)
         {
            param2 = Singleton.getInstance("mx.styles::IStyleManager2") as mx.styles.IStyleManager2;
         }
         this.styleManager = param2;
         if(param1)
         {
            if(param1 is mx.styles.CSSSelector)
            {
               this.selector = param1 as mx.styles.CSSSelector;
            }
            else
            {
      ...
      public function get selector() : mx.styles.CSSSelector
      {
         return this._selector;
      }
      
      public function set selector(param1:mx.styles.CSSSelector) : void
      {
      ...
      mx_internal function set selectorString(param1:String) : void
      {
         ...
         if(param1.charAt(0) == ".")
         {
            ...
            this._selector = new mx.styles.CSSSelector("",[_loc2_]);
         }
         else
         {
            this._selector = new mx.styles.CSSSelector(param1);
         }
      ...
      mx_internal function setLocalStyle(param1:String, param2:*) : void
      {
         ...
         if(param2 is String)
         {
            ...
            {
               this.styleManager = Singleton.getInstance("mx.styles::IStyleManager2") as mx.styles.IStyleManager2;
            }
      ...
      mx_internal function addStyleToProtoChain(param1:Object, param2:DisplayObject, param3:Object = null) : Object
      {
         ...
         var styleParent:mx.styles.IStyleManager2 = this.styleManager.parent;
         while(styleParent)
         {
