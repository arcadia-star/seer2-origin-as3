package mx.styles
{
   ...
   public class StyleProxy implements mx.styles.IAdvancedStyleClient
   {
      ...
      private var _advancedSource:mx.styles.IAdvancedStyleClient;
      ...
      {
         this._source = param1;
         this._advancedSource = param1 as mx.styles.IAdvancedStyleClient;
      }
      ...
      {
         if(this._source.styleName is mx.styles.IStyleClient)
         {
      ...
      public function set styleParent(param1:mx.styles.IAdvancedStyleClient) : void
      {
      }
