package mx.formatters
{
   ...
   public class DateBase
   {
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") static function get defaultStringKey() : Array
      {
         initialize();
      ...
      §§namespace("http://www.adobe.com/2006/flex/mx/internal") static function extractTokenDate(param1:Date, param2:Object) : String
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
