package mx.formatters
{
   public class DateFormatter extends Formatter
   {
         ...
         while(_loc10_ < _loc11_)
         {
            ...
            if(!(_loc8_ <= " " || _loc8_ == ","))
            {
               ...
               else if("a" <= _loc8_ && _loc8_ <= "z" || "A" <= _loc8_ && _loc8_ <= "Z")
               {
                  ...
                  _loc15_ = int(DateBase.defaultStringKey.length);
                  _loc16_ = 0;
                  while(_loc16_ < _loc15_)
                  {
                     if((_loc17_ = String(DateBase.defaultStringKey[_loc16_])).toLowerCase() == _loc14_.toLowerCase() || _loc17_.toLowerCase().substr(0,3) == _loc14_.toLowerCase())
                     {
                        if(_loc16_ == 13)
                        {
      ...
      public function set formatString(param1:String) : void
      {
         ...
         this._formatString = param1 != null ? param1 : String(resourceManager.getString("SharedResources","dateFormat"));
      }
      ...
      override public function format(param1:Object) : String
      {
         ...
         return (_loc7_ = new StringFormatter(this.formatString,VALID_PATTERN_CHARS,DateBase.extractTokenDate)).formatValue(param1);
      }
   }
}
