package mx.utils
{
   ...
   public class MediaQueryParser
   {
      ...
      private static var _instance:mx.utils.MediaQueryParser;
      ...
      public static function get instance() : mx.utils.MediaQueryParser
      {
         return _instance;
      }
      
      public static function set instance(param1:mx.utils.MediaQueryParser) : void
      {
         if(!_instance)
         {
            _instance = param1;
      ...
      public function parse(param1:String) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            _loc9_ = int((_loc8_ = this.tokenizeMediaQuery(_loc6_)).length);
      ...
      private function evalExpressions(param1:Array) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc4_ = String(param1[_loc3_])) != "and")
            {
               _loc5_ = _loc4_.split(":");
               _loc6_ = false;
               _loc7_ = false;
