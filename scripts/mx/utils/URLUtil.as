package mx.utils
{
   ...
   public class URLUtil
   {
      ...
      public static function urisEqual(param1:String, param2:String) : Boolean
      {
         ...
         {
            param1 = String(StringUtil.trim(param1).toLowerCase());
            param2 = String(StringUtil.trim(param2).toLowerCase());
      ...
      public static function stringToObject(param1:String, param2:String = ";", param3:Boolean = true) : Object
      {
         ...
         var _loc4_:Object = {};
         var _loc5_:Array;
         var _loc6_:int = int((_loc5_ = param1.split(param2)).length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc9_ = String((_loc8_ = _loc5_[_loc7_].split("="))[0]);
            if(param3)
            {
            ...
            _loc11_ = _loc4_;
            _loc12_ = int((_loc8_ = _loc9_.split(".")).length);
            _loc13_ = 0;
            while(_loc13_ < _loc12_ - 1)
            {
               _loc15_ = String(_loc8_[_loc13_]);
               if(_loc11_[_loc15_] == null && _loc13_ < _loc12_ - 1)
               {
                  _loc16_ = String(_loc8_[_loc13_ + 1]);
