package MEncrypt
{
   ...
   public function F___sys_pselect() : void
   {
      ...
      _loc10_ = li32(_loc4_);
      _loc8_ = eax;
      if((_loc7_ = li32(_sUITID_2E_4001)) == -2)
      {
         _loc2_ -= 16;
         si32(-1,_loc2_);
         ESP = _loc2_;
         ...
         if(_loc6_ >= 0)
         {
            ...
            addr115:
            var _loc1_:* = li32(_sUITID_2E_4001);
            if((_loc6_ = int(realThreadId)) != _loc1_)
            {
               _loc2_ = _loc6_ = (_loc6_ = (_loc6_ = _loc2_) + -16) & -16;
               si32(_loc4_,_loc6_);
               var _loc5_:*;
               _loc1_ = (_loc5_ = _loc4_ - 32) | 4;
               si32(0,_loc1_);
               si32(0,_loc4_ - 4);
               si32(0,_loc4_ - 8);
               si32(0,_loc4_ - 12);
      ...
      ESP = _loc2_ & -16;
      eax = _loc6_ = int(CModule.kernel.pselect(_loc10_,_loc11_,_loc12_,_loc13_,_loc14_,_loc3_,_loc8_));
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
