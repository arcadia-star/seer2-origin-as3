   ...
   public function F___sys_setsockopt() : void
   {
      ...
      if((_loc7_ = li32(_sUITID_2E_4001)) == -2)
      {
         ...
         if(_loc6_ >= 0)
         {
            ...
            if((_loc6_ = int(realThreadId)) != _loc5_)
            {
               _loc2_ = _loc6_ = (_loc6_ = (_loc6_ = _loc2_) + -16) & -16;
               si32(_loc5_ = _loc4_,_loc6_);
               _loc5_ = _loc4_ - 32 | 4;
               si32(0,_loc5_);
               si32(0,_loc4_ - 4);
               si32(0,_loc4_ - 8);
               ...
               si32(0,_loc4_ - 24);
               si32(0,_loc4_ - 32);
               si32(___sys_setsockopt,_loc4_ - 32);
               si32(_loc6_,_loc5_);
               si32(20,_loc4_ - 24);
               _loc2_ -= 16;
               si32(_loc4_ - 32,_loc2_ + 4);
      ...
      ESP = _loc2_ & -16;
      eax = _loc6_ = int(CModule.kernel.setsockopt(_loc10_,_loc11_,_loc12_,_loc13_,_loc3_,_loc9_));
      _loc2_ = _loc4_;
      ESP = _loc2_;
   }
}
