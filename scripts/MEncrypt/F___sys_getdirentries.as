package MEncrypt
{
   ...
   public function F___sys_getdirentries() : void
   {
      ...
      if((_loc8_ = li32(_sUITID_2E_4001)) == -2)
      {
         ...
         if(_loc6_ >= 0)
         {
            ...
            if((_loc6_ = int(realThreadId)) != _loc5_)
            {
               ...
               si32(_loc5_ = _loc3_,_loc6_);
               var _loc4_:int;
               _loc5_ = (_loc4_ = _loc3_ - 32) | 4;
               si32(0,_loc5_);
               si32(0,_loc3_ - 4);
               si32(0,_loc3_ - 8);
               si32(0,_loc3_ - 12);
      ...
      ESP = _loc2_ & -16;
      eax = _loc6_ = int(CModule.kernel.getdirentries(_loc10_,_loc11_,_loc12_,_loc1_,_loc9_));
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
}
