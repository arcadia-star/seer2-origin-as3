package MEncrypt__3A__5C_alchemy_5C_cygwin_5C_tmp_5C_cc80XT98_2E_lto_2E_bc_3A_1b3fc948_2D_82a0_2D_4fee_2D_a9ab_2D_31c892a97f18
{
   ...
   public function F___printf_render_pct() : void
   {
      ...
      if(_loc6_ == 0)
      {
         si32(L__2E_str2307,li32(_loc1_ + 80));
         si32(_loc5_ = 1,li32(_loc1_ + 80) + 4);
         si32(_loc6_ = (_loc6_ = li32(_loc1_ + 12)) + 1,_loc1_ + 12);
         si32(_loc6_ = (_loc6_ = li32(_loc1_ + 80)) + 8,_loc1_ + 80);
         si32(_loc6_ = (_loc6_ = li32(_loc1_ + 8)) + 1,_loc1_ + 8);
         if(_loc6_ >= 8)
         {
            _loc2_ -= 16;
            var _loc4_:int;
            ...
            F___sfvwrite();
            _loc2_ += 16;
            si32(_loc6_ = _loc1_ + 16,_loc1_ + 80);
