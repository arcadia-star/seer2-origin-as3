   ...
   public final class FSM_ifree extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         while(true)
         {
            ...
            _loc7_ = _loc4_ << 2;
            _loc8_ = li32(_loc7_ = _loc6_ + _loc7_);
            _loc9_ = _loc6_;
               ...
               if(_loc8_ == 2)
               {
                  if(_loc8_ != 1)
                  {
                     if((_loc5_ &= 4095) == 0)
                     {
                        ...
                        _loc8_ = _loc4_ << 2;
                        si32(_loc5_,_loc7_);
                        if((_loc5_ = li32((_loc5_ = _loc8_ + _loc9_) + 4)) != 3)
                        {
                           _loc1_ = 4096;
                        }
                        else
                        ...
                        else
                        {
                           ...
                           if(uint(_loc4_) > uint(_loc8_))
                           {
                              _loc5_ = 0;
                              si32(_loc1_,_loc2_);
                              si32(_loc8_ = li32(_loc1_ + 4),_loc2_ + 4);
                           ...
                           else
                           {
                              ...
                              if(_loc7_ == _loc3_)
                              {
                                 si32(_loc8_ = _loc7_ + _loc5_,_loc9_);
                                 _loc2_ = li32(_loc1_ + 16);
                                 si32(_loc5_ = _loc2_ + _loc5_,_loc1_ + 16);
                                 _loc2_ = li32(_loc1_);
                                 _loc3_ = _loc1_ + 16;
                                 _loc4_ = _loc1_;
                                 if(_loc2_ != 0)
                                 {
                                    ...
                                    if(_loc8_ == _loc6_)
                                    {
                                       si32(_loc8_ = li32(_loc2_ + 12),_loc9_);
                                       si32(_loc5_ = (_loc8_ = li32(_loc2_ + 16)) + _loc5_,_loc3_);
                                       si32(_loc5_ = li32(_loc2_),_loc4_);
                                       if(_loc5_ == 0)
                                       {
                                          _loc5_ = _loc2_;
                                          addr720:
                              ...
                              {
                                 _loc2_ = 0;
                                 si32(_loc5_ = (_loc8_ = li32(_loc1_ + 16)) + _loc5_,_loc1_ + 16);
                                 si32(_loc3_,_loc6_);
                                 _loc5_ = _loc2_;
                              }
                              else
            ...
            _loc2_ = (_loc4_ = _loc5_ & 4095) >>> _loc2_;
            _loc4_ = _loc8_ + 10;
            if((_loc5_ = (_loc6_ = _loc1_ + -1) & _loc5_) != 0)
            {
               break;
            }
            _loc5_ = 1;
            _loc6_ = (_loc6_ = _loc2_ & -32) >>> 3;
            ...
            if((_loc6_ = (_loc6_ = (_loc6_ = li8(_malloc_junk_2E_b)) ^ 1) & 1) == 0)
            {
               _loc6_ = -48;
