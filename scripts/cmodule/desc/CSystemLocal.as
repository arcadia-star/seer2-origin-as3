package cmodule.desc
{
   ...
   public class CSystemLocal implements CSystem
   {
      ...
      public function CSystemLocal(param1:Boolean = false)
      {
         ...
         gtextField.width = !!gsprite ? Number(gsprite.stage.stageWidth) : 800;
         gtextField.height = !!gsprite ? Number(gsprite.stage.stageHeight) : 600;
      ...
      public function open(param1:int, param2:int, param3:int) : int
      {
         ...
         _loc4_ = String(gstate.gworker.stringFromPtr(param1));
         if(param2 != 0)
         {
      ...
      public function psize(param1:int) : int
      {
         ...
         _loc2_ = String(gstate.gworker.stringFromPtr(param1));
      ...
      public function access(param1:int, param2:int) : int
      {
         ...
         _loc3_ = String(gstate.gworker.stringFromPtr(param1));
         if(param2 & ~4)
         {
