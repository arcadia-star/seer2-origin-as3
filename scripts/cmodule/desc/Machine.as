package cmodule.desc
{
   ...
   public class Machine extends MemUser
   {
      ...
      public var mstate:cmodule.desc.MState;
      
      public var dbgLabel:int = 0;
      
      public var caller:cmodule.desc.Machine;
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:cmodule.desc.Machine = this;
         while(_loc1_)
         {
            _loc2_++;
      ...
      public function debugLoc(param1:int, param2:int) : void
      {
         ...
         var _loc4_:Object;
         if((Boolean(_loc4_ = dbgBreakpoints[_loc3_])) && Boolean(_loc4_.enabled))
         {
            if(_loc4_.temp)
            {
      ...
      public function getSecsSetMS() : uint
      {
         ...
         cmodule.desc.Machine.sMS = _loc1_ % 1000;
         return _loc1_ / 1000;
      }
      ...
      {
         var framePtr:int = 0;
         var cur:cmodule.desc.Machine = this;
         trace("");
         trace("*** backtrace");
